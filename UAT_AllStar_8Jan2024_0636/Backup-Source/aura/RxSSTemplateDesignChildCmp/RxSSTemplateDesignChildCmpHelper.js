({
    ...
    getCalculations : function(component,event,helper, currentValue, fieldName,isGuidancePrice1,isGuidancePrice2,isMarketingPrice1,isMarketingPrice2,isSalesPrice1,isSalesPrice2){  
        ...
        var proposedPriceMarketing2 = LineItem.Phoenix_Retail_Indirect_Price__c;
          var proposedPriceMarketingNet = LineItem.Phoenix_Retail_Indirect_Net__c;
          var cmfee = LineItem.Phoenix_Contract_Mngment_Fee_Wholesaler__c; 
           var rdc = LineItem.Phoenix_RDC_NLC__c;
         var bidRecord = component.get("v.bidRecord");
           var cashterms =bidRecord.Phoenix_Current_CD__c;
        
         //console.log('proposedPriceMarketing1-----'+proposedPriceMarketing1);
         // console.log('proposedPriceMarketing2-----'+proposedPriceMarketing2);
          //console.log('proposedPriceMarketingNet-----'+proposedPriceMarketingNet.toFixed(2));
        
         //console.log('cmfee-----'+cmfee);
         // console.log('rdc-----'+rdc);
          //console.log('cashterms-----'+cashterms);
         //var retailDirectPrice = LineItem.Phoenix_Retail_Direct_Price__c != null ? LineItem.Phoenix_Retail_Direct_Price__c : LineItem.Phoenix_Retail_Direct_Sales_Price__c != null ? LineItem.Phoenix_Retail_Direct_Sales_Price__c : LineItem.Phoenix_Current_Retail_Direct_Price__c != null ? LineItem.Phoenix_Current_Retail_Direct_Price__c : 0;
 //console.log('retailDirectPrice-----'+retailDirectPrice);
        //if(proposedPriceMarketing1==null ||proposedPriceMarketing1==undefined)proposedPriceMarketing1=0;
           //if(proposedPriceMarketing2==null ||proposedPriceMarketing2==undefined)proposedPriceMarketing2=0;
         //var proposedPriceMarketingNet1=retailDirectPrice+(proposedPriceMarketing2*(cmfee/100))+(((rdc/100)*WAC)-((cashterms/100)*retailDirectPrice));
        //console.log('proposedPriceMarketingNet1-----'+proposedPriceMarketingNet1.toFixed(2));
        //proposedPriceMarketingNet1=proposedPriceMarketingNet1.toFixed(2);
        var diffPriceIndirect=LineItem.Phoenix_Wholesaler_Diff_Price_Indirect__c;
        var msg1= isMarketingPrice1 ? 'Retail Direct Marketing Price can not be greater than WAC ($'+LineItem.Phoenix_WAC__c+')' : isSalesPrice1 ? 'Retail Direct Sales Price can not be greater than WAC ($'+LineItem.Phoenix_WAC__c+')' : ''; 
        var msg2= isMarketingPrice2 ? 'Retail Indirect Marketing Price can not be greater than WAC ($'+LineItem.Phoenix_WAC__c+')' : isSalesPrice2 ? 'Wholesaler Sales Price can not be greater than WAC ($'+LineItem.Phoenix_WAC__c+')' : ''; 
        
        if((WAC != 0 && WAC != undefined ) && ((WAC < proposedPriceSales1 || WAC < proposedPriceMarketing1) && !isGuidancePrice1)|| ((WAC < proposedPriceSales2 || WAC < proposedPriceMarketing2) && !isGuidancePrice2)){
            
            if((WAC < proposedPriceSales1 || WAC < proposedPriceMarketing1) && !isGuidancePrice1){
            ...
            if((WAC < proposedPriceSales2 || WAC < proposedPriceMarketing2) && !isGuidancePrice2){
            ...
            if(WAC < proposedPriceSales1){component.set("v.singleRec.Phoenix_Retail_Direct_Sales_Price__c", null);}
            
            if(WAC < proposedPriceSales2){	component.set("v.singleRec.Phoenix_Wholesaler_Sales_Price__c", null);}
            
            if(WAC < proposedPriceMarketing1){   component.set("v.singleRec.Phoenix_Retail_Direct_Price__c", null)}
            ...
            action.setCallback(this, function(response) 
                               {
                                   if(response.getState()==='SUCCESS'){
                                       ...
                                       var WHLSDRLPrice = component.get("v.singleRec.Phoenix_Wholesaler_DRL_Net_Price__c") != null ? component.get("v.singleRec.Phoenix_Wholesaler_DRL_Net_Price__c") : 0;
                                       var AndaDRLPrice = component.get("v.singleRec.Phoenix_Anda_DRL_Net_price__c") != null ? component.get("v.singleRec.Phoenix_Anda_DRL_Net_price__c") : 0;
        ...
        /*else if(WAC<proposedPriceMarketing2 && bidType!='Volume Review Only'){
            var toastEvent = $A.get("e.force:showToast");
            toastEvent.setParams({
                "type":"Error",
                "title": "Error",
                "message": 'Retail Indirect Marketing Price can not be greater than WAC ($'+LineItem.Phoenix_WAC__c+')'
            });
            toastEvent.fire();
            component.set("v.singleRec.Phoenix_Retail_Indirect_Price__c", null);
        }*/
       /* else if(proposedPriceMarketing2<proposedPriceMarketing1  && bidType!='Volume Review Only'){
              if(proposedPriceMarketing2!=null && proposedPriceMarketing2!=undefined){
            var toastEvent = $A.get("e.force:showToast");
            toastEvent.setParams({
                "type":"Error",
                "title": "Error",
                "message": 'Retail Indirect Marketing Price can not be less than Retail Direct Marketing Price'
            });
            toastEvent.fire();
            component.set("v.singleRec.Phoenix_Retail_Indirect_Price__c", null);
              }
        }*/
         /*else if(proposedPriceMarketing2<proposedPriceMarketingNet  && bidType!='Volume Review Only'){
            var toastEvent = $A.get("e.force:showToast");
            toastEvent.setParams({
                "type":"Error",
                "title": "Error",
                "message": 'Retail Indirect Marketing Price can not be less than Retail Indirect Net (Marketing)'
            });
            toastEvent.fire();
            component.set("v.singleRec.Phoenix_Retail_Indirect_Price__c", null);
        }*/
                ...
                if(proposedPriceMarketing2<proposedPriceMarketing1  && bidType!='Volume Review Only'){
              if(proposedPriceMarketing2!=null && proposedPriceMarketing2!=undefined){
            var toastEvent = $A.get("e.force:showToast");
            toastEvent.setParams({
                "type":"Error",
            ...
            component.set("v.singleRec.Phoenix_Retail_Indirect_Price__c", null);
               ...
               /* else  if(proposedPriceMarketing2<proposedPriceMarketingNet1  && bidType!='Volume Review Only' && (isMarketingPrice2 || isMarketingPrice2)){
                        if(proposedPriceMarketing2!=null && proposedPriceMarketing2!=undefined){
            var toastEvent = $A.get("e.force:showToast");
            toastEvent.setParams({
                "type":"Error",
