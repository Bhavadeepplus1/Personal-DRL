({    
    doInit: function(component, event, helper) {
        ...
        var indirectContractPrice;
        var indirectwacPercent;
        if(component.get("v.singleRec.Phoenix_Retail_Direct_Price__c") > 0 && component.get("v.singleRec.Phoenix_Retail_Direct_Price__c") != null && component.get("v.singleRec.Phoenix_Retail_Direct_Price__c") != '' && component.get("v.singleRec.Phoenix_Retail_Direct_Price__c") != undefined){
            wacPercent = (component.get("v.singleRec.Phoenix_WAC__c")/component.get("v.singleRec.Phoenix_Retail_Direct_Price__c")*100).toFixed(2) + '%';
            currentContractPrice = (component.get("v.singleRec.Phoenix_Current_Retail_Direct_Price__c")/component.get("v.singleRec.Phoenix_Retail_Direct_Price__c")*100).toFixed(2) + '%';
        }
         else{
            wacPercent = 'NA'; 
        ...
        if(component.get("v.singleRec.Phoenix_Retail_Indirect_Price__c") > 0 && component.get("v.singleRec.Phoenix_Retail_Indirect_Price__c") != null && component.get("v.singleRec.Phoenix_Retail_Indirect_Price__c") != '' && component.get("v.singleRec.Phoenix_Retail_Indirect_Price__c") != undefined){
          indirectwacPercent   = (component.get("v.singleRec.Phoenix_WAC__c")/component.get("v.singleRec.Phoenix_Retail_Indirect_Price__c")*100).toFixed(2) + '%';
           indirectContractPrice  = (component.get("v.singleRec.Phoenix_Current_Retail_Indirect_Price__c")/component.get("v.singleRec.Phoenix_Retail_Indirect_Price__c")*100).toFixed(2) + '%';
            
        }
        else{
           
            indirectwacPercent = 'NA';
            indirectContractPrice ='NA';
        }
        component.set("v.singleRec.wacPercent",wacPercent);
        component.set("v.singleRec.currentContractPrice",currentContractPrice);
        component.set("v.singleRec.indirectwacPercent",indirectwacPercent);
        component.set("v.singleRec.indirectContractPrice",indirectContractPrice);
        ...
        console.log('isAccpetable----'+isAccpetable);	console.log('isNotAccpetable----'+isNotAccpetable);	console.log('isAccpetable1----'+isAccpetable1);	console.log('isNotAccpetable1----'+isNotAccpetable1);        
        console.log('isAccpetable2----'+isAccpetable2);	console.log('isNotAccpetable2----'+isNotAccpetable2);
    ...
    calcGoalSeek : function(component,event,helper){
        ...
        let vipperunit= parseFloat(component.get("v.singleRec.Phoenix_Proposed_Est_VIP__c")/100);
        vipperunit = Number.isFinite(vipperunit)? vipperunit:0;
        console.log('VIP PER UNIT $--->'+vipperunit);
        let currentcashterms=bidRecord.Phoenix_Current_CD__c;
        currentcashterms = Number.isFinite(currentcashterms)?currentcashterms:0;
        ...
        propadminfee = Number.isFinite(propadminfee)?propadminfee:0;
        ...
        proposedrebatepercentage = Number.isFinite(proposedrebatepercentage)?proposedrebatepercentage:0;
    ...
    calcCustDeadNetGoalSeek:  function(component,event,helper){
        ...
        cdperunit = Number.isFinite(cdperunit)?cdperunit:0;
    ...
    inlineEditOpeningOrderAnda  : function(component,event,helper){  
        component.set("v.OpeningOrderAndaEditMode", true);
        setTimeout(function(){
            component.find("OpeningOrderAnda").focus();
        }, 100);
    },
    inlineEditOpeningOrderWholesaler : function(component,event,helper){  
        component.set("v.OpeningOrderWholesalerEditMode", true);
        setTimeout(function(){
            component.find("OpeningOrderWholesaler").focus();
        }, 100);
    },
    ...
    onCISUChange : function(component,event,helper){       
        ...
        console.log('isGuidancePrice1---'+isGuidancePrice1+'--isGuidancePrice2--'+isGuidancePrice2);
        console.log('isSalesPrice1---'+isSalesPrice1+'--isSalesPrice2--'+isSalesPrice2);
      ...
      var LineItemtable = component.get("v.tableRef");
        ...
        helper.getCalculations(component,event,helper, currentValue, fieldName,isGuidancePrice1,isGuidancePrice2,isMarketingPrice1,isMarketingPrice2,isSalesPrice1,isSalesPrice2);
    ...
    closeOpeningOrderAnda  : function (component, event, helper) {
        component.set("v.OpeningOrderAndaEditMode", false);
    },
    closeOpeningOrderWholesaler  : function (component, event, helper) {
        component.set("v.OpeningOrderWholesalerEditMode", false);
    },
