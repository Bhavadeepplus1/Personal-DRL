...
({
    doInit: function (component, event, helper) {
        ...
        if(productDirector != null && delegatedUser != null && delegatedUser.includes(productDirector) && component.get("v.singleRec.Phoenix_Marketing_Final_Approval__c") == false){
         ...
         var basewacPercent;
        var basecurrentContractPrice;
        var dshwacPercent;
        var dshcurrentContractPrice;
        var autoSubwacPercent;
        var autoSubcurrentContractPrice;
        if(component.get("v.singleRec.Phoenix_Retail_Direct_Price__c") > 0 && component.get("v.singleRec.Phoenix_Retail_Direct_Price__c") != null && component.get("v.singleRec.Phoenix_Retail_Direct_Price__c") != '' && component.get("v.singleRec.Phoenix_Retail_Direct_Price__c") != undefined){
            basewacPercent = (component.get("v.singleRec.Phoenix_WAC__c")/component.get("v.singleRec.Phoenix_Retail_Direct_Price__c")*100).toFixed(2) + '%';
            basecurrentContractPrice = (component.get("v.singleRec.Phoenix_Current_Retail_Direct_Price__c")/component.get("v.singleRec.Phoenix_Retail_Direct_Price__c")*100).toFixed(2) + '%';
        }
        else{
             basewacPercent = 'NA'; 
            basecurrentContractPrice = 'NA';
        }
        if(component.get("v.singleRec.Phoenix_Retail_Indirect_Net__c") > 0 && component.get("v.singleRec.Phoenix_Retail_Indirect_Net__c") != null && component.get("v.singleRec.Phoenix_Retail_Indirect_Net__c") != '' && component.get("v.singleRec.Phoenix_Retail_Indirect_Net__c") != undefined){
            dshwacPercent = (component.get("v.singleRec.Phoenix_WAC__c")/component.get("v.singleRec.Phoenix_Retail_Indirect_Net__c")*100).toFixed(2) + '%';
         dshcurrentContractPrice = (component.get("v.singleRec.Phoenix_Current_Retail_Indirect_Net__c")/component.get("v.singleRec.Phoenix_Retail_Indirect_Net__c")*100).toFixed(2) + '%';
            
        }  
          else{
            dshwacPercent = 'NA';
            dshcurrentContractPrice ='NA';
        }
        if(component.get("v.singleRec.Phoenix_Retail_Indirect_Price__c") > 0 && component.get("v.singleRec.Phoenix_Retail_Indirect_Price__c") != null && component.get("v.singleRec.Phoenix_Retail_Indirect_Price__c") != '' && component.get("v.singleRec.Phoenix_Retail_Indirect_Price__c") != undefined){
            autoSubwacPercent = (component.get("v.singleRec.Phoenix_WAC__c")/component.get("v.singleRec.Phoenix_Retail_Indirect_Price__c")*100).toFixed(2) + '%';
            autoSubcurrentContractPrice = (component.get("v.singleRec.Phoenix_Current_Retail_Indirect_Price__c")/component.get("v.singleRec.Phoenix_Retail_Indirect_Price__c")*100).toFixed(2) + '%';
            
        }
        else{
           autoSubwacPercent = 'NA';
            autoSubcurrentContractPrice ='NA';
           
        }
        component.set("v.singleRec.basewacPercent",basewacPercent);
        component.set("v.singleRec.basecurrentContractPrice",basecurrentContractPrice);
        component.set("v.singleRec.dshwacPercent",dshwacPercent);
        component.set("v.singleRec.dshcurrentContractPrice",dshcurrentContractPrice);
        component.set("v.singleRec.autoSubwacPercent",autoSubwacPercent);
        component.set("v.singleRec.autoSubcurrentContractPrice",autoSubcurrentContractPrice);        
