            ...
            if(response.getState() === "SUCCESS"){
                ...
                if(scmDataList.length>0){
                    ...
                    for(var i=0; i<scmDataList.length; i++){
                        ...
                        var customerName;
                        if(scmDataList[i].bidRecord.hasOwnProperty('Phoenix_Customer__r')){
                            customerName = scmDataList[i].bidRecord.Phoenix_Customer__r.Name;
                        } else if(scmDataList[i].bidLineItem.hasOwnProperty('Phoenix_Customer__r')){
                            customerName = scmDataList[i].bidLineItem.Phoenix_Customer__r.Name;
                        }
                        scmDataList[i].customerName = customerName;
                        ...
                        if(d != null && !isNaN(d)){
                            ...
                            if(scmDataList[i].businessCategory == 'Business Gained'){
                                ...
                                if(scmDataList[i].businessImpact > 0){
                                    ...
                                    } else if(scmDataList[i].bidRecord.Phoenix_Bid_Type__c == 'RFP Bids'){
                                        totalCurrentFiscalImpact +=(scmDataList[i].previousContractTotal * monthsRemaining)/12;
                                        totalCurrentFiscalQuarterImpact +=(scmDataList[i].previousContractTotal * daysRemainingInQuarter)/12;
                                        totalCurrentTPTFiscalImpact +=(scmDataList[i].previousTPT * monthsRemaining)/12;
                                        totalCurrentTPTFiscalQuarterImpact +=(scmDataList[i].previousTPT * daysRemainingInQuarter)/12;
                    ...
                    totalObj.totalCurrentQuarterImpact = parseFloat((isNaN(totalCurrentQuarterImpactBG) ? 0: totalCurrentQuarterImpactBG) + (isNaN(totalCurrentQuarterImpactBGG) ? 0: totalCurrentQuarterImpactBGG) + (isNaN(totalCurrentQuarterImpactBGL) ? 0: totalCurrentQuarterImpactBGL) + (isNaN(totalCurrentQuarterImpactBL) ? 0: totalCurrentQuarterImpactBL)); // + (isNaN(totalBusinessImpactNE) ? 0: totalBusinessImpactNE)
                    ...
                    var manufacturerMap = {}; var totalMap = {};
                    ...
                    scmDataList.forEach(function(rec){
                        ...
                        if(rec.bidLineItem.Phoenix_Product__r.hasOwnProperty('Phoenix_Finished_Goods_Supplier_Name__c')){
                            manufacturerName = rec.bidLineItem.Phoenix_Product__r.Phoenix_Finished_Goods_Supplier_Name__c;
                        } else {
                            manufacturerName = 'N/A';
                        }
                        if(manufacturerMap.hasOwnProperty(manufacturerName)){
                            var customerRelatedList = manufacturerMap[manufacturerName];
                            customerRelatedList.push(rec);
                            manufacturerMap[manufacturerName] = customerRelatedList;                            
                        } else{
                        ...
                        if(manufacturerMap != null){
                            ...
                            var customerKeys = Object.keys(manufacturerMap);
                            for(var i=0; i<customerKeys.length; i++){
                                var relatedCustomerList = manufacturerMap[customerKeys[i]];
                    ...
                    component.set("v.manufacturerMap", manufacturerMap);
                    component.set("v.customerIds", Object.keys(manufacturerMap));
                    var tempObj = {};
