...
({
    doInit: function (component, event, helper) {
        ...
        console.log('deligatedUserName--' + component.get("v.deligatedUserName"));
        ...
        if(component.get("v.singleRec.Phoenix_ProposedContractBidPriceMktng__c") > 0 && component.get("v.singleRec.Phoenix_ProposedContractBidPriceMktng__c") != null && component.get("v.singleRec.Phoenix_ProposedContractBidPriceMktng__c") != '' && component.get("v.singleRec.Phoenix_ProposedContractBidPriceMktng__c") != undefined){
              if(component.get("v.templateType") == 'Direct'){
console.log("In direct col");
            ...
            else if(component.get("v.templateType") == 'Indirect'){
                console.log("In indirect col");
                  currentContractPrice = (component.get("v.singleRec.Phoenix_Current_Indirect_Price__c")/component.get("v.singleRec.Phoenix_ProposedContractBidPriceMktng__c")*100).toFixed(2) + '%';
        console.log("In direct col=="+currentContractPrice);
     ...
     console.log("In direct col out=="+currentContractPrice);
        }
        else{
           wacPercent = 'NA'; 
    ...
    calcGoalSeek : function(component,event,helper){
       ...
       let adminBasis = component.get("v.singleRec.Phoenix_Fee_G_N__c");
        ...
        let wholesalerFee = parseFloat((component.get("v.singleRec.Phoenix_Whlsr_Controlled_Substance_Fee__c")!= null && component.get("v.singleRec.Phoenix_Whlsr_Controlled_Substance_Fee__c") != undefined) ? component.get("v.singleRec.Phoenix_Whlsr_Controlled_Substance_Fee__c") : 0);
        console.log('wholesalerFee====='+wholesalerFee);
               
        if(templateType=='Direct' || templateType=='Direct and Indirect'){
            if(adminBasis=='Gross' && rebateBasis=='Gross'){
                let requirePrice = (((perUnitReabate+deadnetPrice)- finalVIP*perUnitReabate)/(1-finalRebate-finalVIP-finalCd-finalAdminFee));
                ...
                //let requirePrice = (((deadnetPrice)+(finalRebate*perUnitReabate+perUnitReabate*finalAdminFee)-(perUnitReabate-(perUnitReabate*finalAdminFee)-(finalAdminFee*finalRebate)))/(1-(finalRebate+finalVIP+finalCd+finalAdminFee)));
                 let requirePrice = ((deadnetPrice+(perUnitReabate-((perUnitReabate*finalAdminFee)+(finalVIP*perUnitReabate)+(perUnitReabate*finalRebate))))/(1-(finalRebate+finalVIP+finalCd+finalAdminFee)));
                ...
                component.set("v.RequiredPrice",requirePrice);
                   ...
                   let requirePrice = (((deadnetPrice)+(perUnitReabate-(perUnitReabate*finalRebate)-(perUnitReabate*finalVIP)))/(1-(finalRebate+finalVIP+finalCd+finalAdminFee)));
                ...
                component.set("v.RequiredPrice",requirePrice);
                   ...
                   let requirePrice = (((deadnetPrice)+(perUnitReabate-(perUnitReabate*finalAdminFee)-(perUnitReabate*finalVIP)))/(1-(finalRebate+finalVIP+finalCd+finalAdminFee)));
                    
               component.set("v.RequiredPrice",requirePrice);
                } 
            else if((rebateBasis== null || rebateBasis == 'undefined' || rebateBasis == undefined) && adminBasis=='Net'){ 
                    //let requirePrice = (((deadnetPrice)+(finalRebate*perUnitReabate+perUnitReabate*finalAdminFee)-(perUnitReabate-(perUnitReabate*finalAdminFee)))/(1-finalRebate-finalVIP-finalCd-finalAdminFee));
                   let requirePrice = (((deadnetPrice)+(perUnitReabate-(perUnitReabate*finalVIP)))/(1-(finalVIP+finalCd+finalAdminFee)));
               ...
               component.set("v.RequiredPrice",requirePrice);
                ...
                console.log("admin fee null and rebate Net")
                    //let requirePrice = (((deadnetPrice)+(finalRebate*perUnitReabate+perUnitReabate*finalAdminFee)-(perUnitReabate-(perUnitReabate*finalAdminFee)))/(1-finalRebate-finalVIP-finalCd-finalAdminFee));
                   let requirePrice = (((deadnetPrice)+(perUnitReabate-(perUnitReabate*finalRebate)-(perUnitReabate*finalVIP)))/(1-(finalVIP+finalCd+finalRebate)));
                    console.log("deadnetPrice--->"+deadnetPrice)
                    console.log("perUnitReabate--->"+perUnitReabate)
                    console.log("finalRebate--->"+finalRebate)
                    console.log("finalVIP--->"+finalVIP)
                    console.log("finalCd--->"+finalCd)
               component.set("v.RequiredPrice",requirePrice);
                }
            else if((adminBasis== null || adminBasis == 'undefined' || adminBasis == undefined) && rebateBasis=='Gross'){ 
                    //let requirePrice = (((deadnetPrice)+(finalRebate*perUnitReabate+perUnitReabate*finalAdminFee)-(perUnitReabate-(perUnitReabate*finalAdminFee)))/(1-finalRebate-finalVIP-finalCd-finalAdminFee));
                   let requirePrice = (((deadnetPrice)+(perUnitReabate-(perUnitReabate*finalVIP)))/(1-(finalVIP+finalCd+finalRebate)));
               ...
               component.set("v.RequiredPrice",requirePrice);
                    ...
                    //let requirePrice = (((deadnetPrice)+(finalRebate*perUnitReabate+perUnitReabate*finalAdminFee)-(perUnitReabate-(perUnitReabate*finalAdminFee)))/(1-finalRebate-finalVIP-finalCd-finalAdminFee));
                   let requirePrice = (((deadnetPrice)+(perUnitReabate-(perUnitReabate*finalVIP)))/(1-(finalVIP+finalCd)));
                    
               component.set("v.RequiredPrice",requirePrice);
                }
        }
        else if(templateType=='Indirect'){
            console.log('Indirect Template')
            if(adminBasis=='Gross' && rebateBasis=='Gross'){
                
                //satya added rebateperc because proposed rebate is not adding to the formula:final rebate is showing 0
                let requirePrice = ((deadnetPrice + (WAC*finalIndirectCD )+(wholesalerFee) + (WAC*finalRDCNLC)+(perUnitReabate-(finalVIP*perUnitReabate)))/(1-(finalRebate+finalVIP+finalCMfee+finalAdminFee)));
                component.set("v.RequiredPrice",requirePrice);
                console.log('WAC--->'+WAC);
                console.log('perUnitReabate--->'+perUnitReabate);
                console.log('finalRDCNLC--->'+finalRDCNLC);
                console.log('deadnetPrice--->'+deadnetPrice);
                console.log('finalRebate--->'+finalRebate);
                console.log('finalAdminFee--->'+finalAdminFee);
                console.log('finalVIP--->'+finalVIP);
                console.log('vipPerc-->'+vipPerc)
                console.log('finalIndirectCD--->'+finalIndirectCD);
               
            }
            else if(adminBasis=='Net' && rebateBasis=='Net'){
                //satya added rebateperc because proposed rebate is not adding to the formula:final rebate is showing 0
                let requirePrice = ((deadnetPrice + (wholesalerFee) + (WAC*finalIndirectCD + WAC*finalRDCNLC)+(perUnitReabate-(perUnitReabate*finalAdminFee)-(perUnitReabate*finalRebate)-(finalVIP*perUnitReabate)))/(1-(finalRebate+finalVIP+finalCMfee+finalAdminFee)));
                console.log('perUnitReabate--->'+perUnitReabate);
                console.log('deadnetPrice--->'+deadnetPrice);
                console.log('finalRebate--->'+finalRebate);
                console.log('finalAdminFee--->'+finalAdminFee);
                ...
                component.set("v.RequiredPrice",requirePrice);
                 ...
                 //satya added rebateperc because proposed rebate is not adding to the formula:final rebate is showing 0
                    let requirePrice = ((deadnetPrice+(wholesalerFee)+ (WAC*finalIndirectCD + WAC*finalRDCNLC)+(perUnitReabate-(perUnitReabate*finalRebate)-(finalVIP*perUnitReabate)))/(1-(finalRebate+finalVIP+finalCMfee+finalAdminFee)));
                    component.set("v.RequiredPrice",requirePrice);
                   console.log('gross or net')
            }
           else if(adminBasis=='Net' && rebateBasis=='Gross'){ 
              //satya added rebateperc because proposed rebate is not adding to the formula:final rebate is showing 0 
               let requirePrice = ((deadnetPrice +(wholesalerFee) + (WAC*finalIndirectCD + WAC*finalRDCNLC)+(perUnitReabate-(perUnitReabate*finalAdminFee)-(perUnitReabate*finalVIP)))/(1-(finalRebate+finalVIP+finalCMfee+finalAdminFee)));
                                        component.set("v.RequiredPrice",requirePrice);
                  console.log('WAC--->'+WAC);
                console.log('perUnitReabate--->'+perUnitReabate);
                console.log('finalRDCNLC--->'+finalRDCNLC);
                ...
                console.log('finalIndirectCD--->'+finalIndirectCD);
                    ...
                    //let requirePrice = (((deadnetPrice)+(finalRebate*perUnitReabate+perUnitReabate*finalAdminFee)-(perUnitReabate-(perUnitReabate*finalAdminFee)))/(1-finalRebate-finalVIP-finalCd-finalAdminFee));
                   let requirePrice = ((deadnetPrice + (wholesalerFee) + (WAC*finalIndirectCD + WAC*finalRDCNLC)+(perUnitReabate-(perUnitReabate*finalAdminFee)-(finalVIP*perUnitReabate)))/(1-(finalVIP+finalCMfee+finalAdminFee)));
                    
               component.set("v.RequiredPrice",requirePrice);
                } 
            else if((rebateBasis== null || rebateBasis == 'undefined' || rebateBasis == undefined) && adminBasis=='Gross'){ 
                    //let requirePrice = (((deadnetPrice)+(finalRebate*perUnitReabate+perUnitReabate*finalAdminFee)-(perUnitReabate-(perUnitReabate*finalAdminFee)))/(1-finalRebate-finalVIP-finalCd-finalAdminFee));
                   let requirePrice = ((deadnetPrice +(wholesalerFee) +(WAC*finalIndirectCD + WAC*finalRDCNLC)+(perUnitReabate-(finalVIP*perUnitReabate)))/(1-(finalVIP+finalCMfee+finalAdminFee)));
               ...
               component.set("v.RequiredPrice",requirePrice);
                ...
                console.log("admin fee null and rebate Net")
                    //let requirePrice = (((deadnetPrice)+(finalRebate*perUnitReabate+perUnitReabate*finalAdminFee)-(perUnitReabate-(perUnitReabate*finalAdminFee)))/(1-finalRebate-finalVIP-finalCd-finalAdminFee));
                   let requirePrice = ((deadnetPrice + (wholesalerFee) + (WAC*finalIndirectCD + WAC*finalRDCNLC)+(perUnitReabate-(perUnitReabate*finalRebate)-(finalVIP*perUnitReabate)))/(1-(finalRebate+finalVIP+finalCMfee)));
                    console.log("deadnetPrice--->"+deadnetPrice)
                    console.log("perUnitReabate--->"+perUnitReabate)
                    console.log("finalRebate--->"+finalRebate)
                    console.log("finalVIP--->"+finalVIP)
               ...
               component.set("v.RequiredPrice",requirePrice);
                    ...
                    //let requirePrice = (((deadnetPrice)+(finalRebate*perUnitReabate+perUnitReabate*finalAdminFee)-(perUnitReabate-(perUnitReabate*finalAdminFee)))/(1-finalRebate-finalVIP-finalCd-finalAdminFee));
                   let requirePrice = ((deadnetPrice + (wholesalerFee) +(WAC*finalIndirectCD + WAC*finalRDCNLC)+(perUnitReabate-(finalVIP*perUnitReabate)))/(1-(finalRebate+finalVIP+finalCMfee)));
                    
               component.set("v.RequiredPrice",requirePrice);
                }
             else if((adminBasis== null || adminBasis == 'undefined' || adminBasis == undefined) && (rebateBasis== null || rebateBasis == 'undefined' || rebateBasis == undefined)){ 
                    //let requirePrice = (((deadnetPrice)+(finalRebate*perUnitReabate+perUnitReabate*finalAdminFee)-(perUnitReabate-(perUnitReabate*finalAdminFee)))/(1-finalRebate-finalVIP-finalCd-finalAdminFee));
                   let requirePrice = ((deadnetPrice +(wholesalerFee) + (WAC*finalIndirectCD + WAC*finalRDCNLC)+(perUnitReabate-(finalVIP*perUnitReabate)))/(1-(finalVIP+finalCMfee)));
                    
               component.set("v.RequiredPrice",requirePrice);
                }
            
        }
        /*else if(templateType=='Direct and Indirect'){
            if(adminBasis=='Gross' && rebateBasis=='Gross'){
                let requirePrice = ((perUnitReabate+deadnetPrice)/(1-finalRebate-finalVIP-finalCd-finalAdminFee));
                component.set("v.RequiredPrice",requirePrice);
            }
            else if(adminBasis=='Net' && rebateBasis=='Net'){
