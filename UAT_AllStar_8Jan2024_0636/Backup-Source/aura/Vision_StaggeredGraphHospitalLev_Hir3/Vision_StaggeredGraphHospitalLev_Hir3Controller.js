({
	 initCharts: function(component, event, helper){
        ...
        var hospitalrelatedList = component.get("v.hospitalrelatedList");
         var hospitalPFamilyList =  component.get("v.hospitalPFamilyList");
         /*family wise data*/
         var pfamilymapObj ={};
        var allData= [];
        ...
        for(var i=0; i<keys.length; i++){
         ...
         let uniqueFamilies = [];
          hospitalPFamilyList.forEach(function(rec){
