...
({
    ...
    convertArrayOfObjectsToCSV: function (component, objectRecords, template, bidType) {
        ...
        if(bidType != 'New Product Launch'){
            if (template == 'Direct' || template == "Direct and Indirect") {
                if (bidType != 'Volume Review Only' && bidType != 'Sales Out Rebate' && bidType != 'New Product Launch' && bidType != 'New Customer') {
                    myMap.set("% Reduction in Direct Price", "Phoenix_Reduc_in_NCP_McK_And_RAD__c");
                }
            ...
            if (template == 'Indirect' || template == "Direct and Indirect") {
                if (bidType != 'Volume Review Only' && bidType != 'Sales Out Rebate' && bidType != 'New Product Launch' && bidType != 'New Customer') {
                    myMap.set("% Reduction in Indirect Price", "Phoenix_Reduction_in_NCP_WMT__c");
                }
            }
        }
        if (bidType != 'Volume Review Only' && bidType != 'Sales Out Rebate') {
        ...
        if (template == "Direct and Indirect") {
            ...
            myMap.set("Direct TP $ Per Pack", "Phoenix_Anda_DRL_TPT__c");
        ...
        if (template == 'Indirect' || template == "Direct and Indirect") {
            myMap.set("Indirect CD $", "Phoenix_INDIRECT_CD__c");
                                                    ...
                                                    if(component.get("v.accountNumber") != '370706'){
                                                        if (template == 'Indirect' || template == "Direct and Indirect") {
        ...
        if (template == "Direct and Indirect") {
            ...
            myMap.set("Indirect TP $ Per Pack", "Phoenix_Retail_Direct_DRL_TPT__c");
            myMap.set("Indirect TP % Per Pack", "Phoenix_Indirect_TP__c");
        }
        if (template == 'Indirect'){
            myMap.set("Wholesaler Controlled Substance Fee$", "Phoenix_Whlsr_Controlled_Substance_Fee__c");
        }
        if (template == 'Indirect' || template == "Direct") {
        ...
        if(bidType != 'New Product Launch'){
            if (bidType == "Sales Out Rebate") {
                ...
                myMap.set("Sales Out Promotion $ Overall amount", "Phoenix_Sales_Out_Promotion__c");
            }
        }
        
        if ( bidType == "New Customer" || bidType == "Product Addition" || bidType == "New Product Launch" || bidType == "RFP Bids") {
            myMap.set("IOD Per Unit $", "Phoenix_IOD_Per_Unit_in__c");
            myMap.set("IOD $ Overall Amount", "Phoenix_IOD_Total_Amount__c");
        }
        ...
        if (template == "Direct and Indirect") {
            myMap.set("Direct Net Sales", "Phoenix_Retail_Direct_Net_sales__c");
            myMap.set("Indirect Net Sales", "Phoenix_Retail_Indirect_Net_Sales__c");
            myMap.set("Total Net Sales", "Phoenix_WMT_Indirect_Net_Sales__c");
            myMap.set("Direct TPT $", "Phoenix_Wholesaler_DRL_TPT__c");
            myMap.set("Indirect TPT $", "Phoenix_WMT_Indirect_TPT__c");
            myMap.set("Total TPT $", "Phoenix_Costco_TPT__c");
            myMap.set("Direct TPT %", "Phoenix_Wholesaler_DRL_TPT_Percent__c");
            myMap.set("Indirect TPT %", "Phoenix_Retail_Direct_DRL_TPT_Percent__c");
            myMap.set("Blended TPT %", "Phoenix_Anda_DRL_TPT_Percent__c");
        }
        ...
        if ( bidType != 'Sales Out Rebate' && bidType != "Customer Rebate Change" && bidType != "Price Change") {
            ...
            }else if(bidType == 'New Product Launch'){
        ...
        if (bidType != 'Sales Out Promotional Discount' && bidType != 'Sales Out Rebate' && bidType != "Customer Rebate Change" && bidType != "Price Change") {
            if (template == "Direct and Indirect" || template == "Direct" || template == "Indirect") {
                if(bidType != "New Product Launch"){
        ...
        if (bidType == 'New Customer' || bidType == 'New Product Launch' ||  bidType == "RFP Bids" || bidType == "Product Addition") {   
        ...
        action.setCallback(this, function (response) {
            if (response.getState() === "SUCCESS") {
                ...
                for (var i = 0; i < resultlength; i++) {
                    if (bidType != 'Volume Review Only' && bidType != 'Sales Out Rebate' && component.get("v.BidAprrovalStatus") != 'Draft' && (ResultData[i].Phoenix_Product_Director__c == component.get("v.loggedInUserName") || (delegatedUser != null && delegatedUser.includes(ResultData[i].Phoenix_Product_Director__c))) && ResultData[i].Phoenix_ProposedContractBidPriceMktng__c == null && ResultData[i].Phoenix_Marketing_Approval__c != 'Not Approved') {
                ...
                for (var i = 0; i < resultlength; i++) {
                    if(component.get("v.BidAprrovalStatus")!='Draft' && ResultData[i].Phoenix_Product_Director__c==component.get("v.loggedInUserName") && (bidType !='New Product Launch' && bidType != 'New Customer') && ResultData[i].Phoenix_Override_Current_Direct_Units__c==null && (ResultData[i].Phoenix_Current_Direct_Selling_Unit__c==null || ResultData[i].Phoenix_Current_Direct_Selling_Unit__c==undefined || ResultData[i].Phoenix_Current_Direct_Selling_Unit__c==0)){                                             
                        isOverrideUnitsavl =true;
                        break;
                    }
                    else if(component.get("v.BidAprrovalStatus")!='Draft' && ResultData[i].Phoenix_Product_Director__c==component.get("v.loggedInUserName") && (bidType !='New Product Launch' && bidType != 'New Customer') && ResultData[i].Phoenix_Override_Current_Indirect_Units__c==null && (ResultData[i].Phoenix_Current_Indirect_Selling_Unit__c==null || ResultData[i].Phoenix_Current_Indirect_Selling_Unit__c==undefined || ResultData[i].Phoenix_Current_Indirect_Selling_Unit__c==0)){                                             
                        isOverrideUnitsavl =true;
                        break;
                    }
                }
