({
	convertArrayOfObjectsToCSV : function(component,objectRecords,template){
        ...
        myMap.set("RCA Agreement", "Phoenix_RCA_Agreement__r.Name");
      ...
      console.log('1-->');
        ...
        for(var i=0; i < objectRecords.length; i++){  
            ...
            for (let [key, value] of myMap) {
             ...
             if(value != 'Phoenix_RCA_Change_Date__c' && value != 'Phoenix_RCA_Agreement__r.Name' && value != 'Phoenix_Contract__r.Name' && value != 'Phoenix_Customer__r.Name'){
