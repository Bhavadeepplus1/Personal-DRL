({
    ...
    closeModel: function(component, event, helper) {
       ...
       openDirectModal: function(component, event, helper) {
        // Set isModalOpen attribute to true
        
        component.set('v.loaded',true);
        console.log('sku code----'+component.get("v.singlerec.Vision_Product__r.ProductCode"));
        console.log('acc code----'+component.get("v.recordId"));
        var getBidInfoAction = component.get("c.getDirectAwardedPositionData");
        getBidInfoAction.setParams({
    ...
    openIndirectModal: function(component, event, helper) {
        // Set isModalOpen attribute to true
        
        component.set('v.loaded',true);
        console.log('sku code----'+component.get("v.singlerec.Vision_Product__r.ProductCode"));
        console.log('acc code----'+component.get("v.recordId"));
        var getBidInfoAction = component.get("c.getIndirectAwardedPositionData");
        getBidInfoAction.setParams({
