({
    buildData: function(component, event, helper, recentData, previousData){
        ...
        if(comparison == 'lastquartervspreviousquarter'){
            ...
            for(var key in previousData){
                ...
                console.log('Sales Previous: '+salesPrevious);
            ...
            console.log('keyset1-->'+keySet);
            for(var k=0;k<=keySet.length;k++){
                for (var key in recentData){
                     console.log('in for-->'+salesdl);
                    if(recentData.includes(keySet[k])){
                         console.log('in if-->'+salesdl);
                         salesdl.push(recentData[key]['salesMonthly']);
                    }else{
                        console.log('in else-->'+salesdl);
                        salesdl.push(0);
                    }
