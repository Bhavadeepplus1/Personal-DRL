...
({
    ...
    inlineEditFeeType: function (component, event, helper) {
	 ...
	 inlineEditDating: function (component, event, helper) {
        component.set("v.DatingEdit", true);
        setTimeout(function () {
            component.find("inputDatingId").focus();
        }, 100);
    },
    ...
    inlineEditBatchID: function (component, event, helper) {
        component.set("v.batchEditMode", true);
        setTimeout(function () {
            component.find("inputBatchId").focus();
        }, 100);
    },
     inlineEditExpiration: function (component, event, helper) {
        component.set("v.ExpirationEditMode", true);
        setTimeout(function () {
            component.find("inputExpirationId").focus();
        }, 100);
    },
    ...
    onCISUChange: function (component, event, helper) {
        ...
        if (nameofEditfield == 'rebateType') {
            ...
            currentValue = val;
            fieldName = nameofEditfield;
        }else if (nameofEditfield == 'Dating') {
            currentValue = val;
            fieldName = nameofEditfield;
        }
            else {
    ...
    closeFeeTypeBox: function (component, event, helper) {
     ...
     closeDatingBox: function (component, event, helper) {
        component.set("v.DatingEdit", false);
    ...
    closeBatchIDBox: function (component, event, helper) {
        component.set("v.batchEditMode", false);
    },
    closeExpirationBox: function (component, event, helper) {
        component.set("v.ExpirationEditMode", false);
    },
