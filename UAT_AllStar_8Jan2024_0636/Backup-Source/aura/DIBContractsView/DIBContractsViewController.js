...
({
    ...
    openModel: function (component, event, helper) {
        ...
        if (appStatus == 'Finance' || appStatus == 'Contracts' || appStatus == 'Customer' || appStatus == "Customer's Update" || appStatus == 'Vistex Update' || appStatus == 'Closed') {
            component.set("v.isOpen", true);
        } else {
            var toastEvent = $A.get("e.force:showToast");
            toastEvent.setParams({
                title: 'Error',
                message: 'You can only generate offer document when in Contracts stage or later stage1',
                duration: ' 5000',
                key: 'info_alt',
                type: 'error'
            });
    ...
    saveToProceedContracts: function (component, event, helper) {
        ...
        if(bid != null && bid.Phoenix_Sent_to_Customer_Date__c != null){
