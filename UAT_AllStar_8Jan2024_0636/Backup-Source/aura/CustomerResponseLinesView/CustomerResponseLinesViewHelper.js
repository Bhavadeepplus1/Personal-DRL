        ...
        action.setCallback(this, function (response){
            if(response.getState() === "SUCCESS"){                
                ...
                if(scmDataList.length>0){
                    ...
                    var totalAnnualImpactBL = 0; var totalBusinessImpactBL = 0; var totalCurrentQuarterImpactBL = 0; var currentTotalBL = 0; var previousTotalBL = 0; var tptVariance =0; var priceVariance =0; var volumeVariance =0;
                    ...
                    var totalPreviousQtyBLRFP = 0; var totalSCMApprovedQtyBL = 0; var totalQtyBL = 0; var totalQtyBLRFP = 0; var currentTotalBLRFP = 0; var previousTotalBLRFP = 0; var tptVarianceBLRFP =0; var priceVarianceBLRFP =0; var volumeVarianceBLRFP =0;var previousTPTBLRFP = 0; var currentTPTBLRFP = 0; var priceVarianceBLRFP = 0; var volumeVarianceBLRFP = 0; var totalVarianceBLRFP = 0; var tptVarianceBLRFP = 0;
                    var totalAnnualImpactBLRemovals = 0; var totalPreviousQtyBL = 0; var totalBusinessImpactBLRemovals = 0;var totalAnnualImpactBLDiscontinuation = 0; var totalBusinessImpactBLDiscontinuation = 0;var totalAnnualImpactBLRFP = 0; var totalBusinessImpactBLRFP = 0; var totalCurrentQuarterImpactBLRFP = 0;
                    ...
                    for(var i=0; i<scmDataList.length; i++){
                        ...
                        if(d != null && !isNaN(d)){
                            ...
                            console.log('Days Remaining: '+daysRemainingInQuarter);
                            console.log('****************************');
                            ...
                            var days_difference = Math.round((time_difference / (1000 * 60 * 60 * 24)).toFixed(1));
                            ...
                            if(scmDataList[i].businessCategory == 'Business Gained'){
                                ...
                                totalCurrentQuarterImpactBG += ((isNaN(scmDataList[i].currentQuarterImpact) ? 0 : scmDataList[i].currentQuarterImpact));
                                ...
                                if(scmDataList[i].businessImpact > 0){
                                    ...
                                    totalCurrentQuarterImpactBGG += ((isNaN(scmDataList[i].currentQuarterImpact) ? 0 : scmDataList[i].currentQuarterImpact));
                                    ...
                                    totalCurrentQuarterImpactBGL += ((isNaN(scmDataList[i].currentQuarterImpact) ? 0 : scmDataList[i].currentQuarterImpact));
                                    ...
                                    if(scmDataList[i].bidRecord.Phoenix_Bid_Type__c == 'RFP Bids' || scmDataList[i].bidRecord.Phoenix_Bid_Type__c == 'Price Change' || scmDataList[i].bidRecord.Phoenix_Bid_Type__c == 'OTC Price Change'){
                                        ...
                                        totalCurrentQuarterImpactBL += ((isNaN(scmDataList[i].currentQuarterImpact) ? 0 : scmDataList[i].currentQuarterImpact));
                                        ...
                                        totalCurrentQuarterImpactBLRFP += ((isNaN(scmDataList[i].currentQuarterImpact) ? 0 : scmDataList[i].currentQuarterImpact));
                                        ...
                                        totalCurrentQuarterImpactNE += ((isNaN(scmDataList[i].currentQuarterImpact) ? 0 : scmDataList[i].currentQuarterImpact));
                                        ...
                                        noEffectList.push(scmDataList[i]);
                                            ...
                                            totalCurrentQuarterImpactOS += ((isNaN(scmDataList[i].currentQuarterImpact) ? 0 : scmDataList[i].currentQuarterImpact));
                    ...
                    totalObj.totalCurrentQuarterImpactBG = parseInt(totalCurrentQuarterImpactBG);
                    totalObj.totalCurrentQuarterImpactBLRFP = parseInt(totalCurrentQuarterImpactBLRFP);
                    ...
                    totalObj.totalCurrentFiscalQuarterImpact = totalCurrentFiscalQuarterImpact;
                    totalObj.totalProposedFiscalQuarterImpact = totalProposedFiscalQuarterImpact;
                    ...
                    totalObj.totalCurrentTPTFiscalQuarterImpact = totalCurrentTPTFiscalQuarterImpact;
                    totalObj.totalProposedTPTFiscalQuarterImpact = totalProposedTPTFiscalQuarterImpact;
                    ...
                    gainedList.forEach(function(rec){
                        if(gainedMap.hasOwnProperty(rec.productFamily)){
                            ...
                            summary[30] = parseInt(currentQuarterImpact);
