({
    doInit: function(component, event, helper){
        ...
        action33.setCallback(this,function(response){
            if(response.getState() == 'SUCCESS'){
                ...
                component.set("v.indoInit",false);
        ...
        console.log('total hospital count==>'+component.get("v.options3"));
       /*  helper.getRegion(component, event, helper);
   ...
   /* searchSalesUnits:function(component,event,helper){
    ...
    handleChange : function(cmp, event, helper) {
       ...
       //cmp.set("v.chargebackList",'');
        ...
        helper.gethospitalName(cmp, event, helper);
           $A.util.removeClass(cmp.find("LineTable"), 'summaryheaderSticky'); 
       /*  helper.getRegion(cmp, event, helper);
    ...
    handleBlur : function(cmp, event, helper) {
        console.log('Lookup component Id: handleBlur' + event.getParam("cmpId"));
         $A.util.addClass(cmp.find("LineTable"), 'summaryheaderSticky');
    },
    ...
    searchSubmitterName:function(component, event, helper){
     ...
     collectData: function(component, event, helper){
		...
		component.set("v.indoInit",true);         
         $A.util.removeClass(component.find("LineTable"), 'summaryheaderSticky');
         var offsetVal = 0;
         //component.set("v.loadingMessage",'Fetching Hospitals. '+offsetVal)
        helper.getFullData(component, event, helper);
     ...
     searchContracts : function(component, event, helper) {
      ...
      saveDetails : function(component, event, helper) {
        ...
        for(var i=0;i<selectrcs.length;i++){
            if(!selectedCntrcts.includes(selectrcs[i].Contact_Description__c))
            	selectedCntrcts.push(selectrcs[i].Contact_Description__c);
        }   
        console.log('cout of contracts==>'+selectedCntrcts.length)
    ...
    handleNext: function(component, event, helper) {
        ...
        pageNumber++;
        helper.getHosptalsData(component, pageNumber, pageSize);
    },
    ...
    handlePrev: function(component, event, helper) {
     ...
     onSelectChange: function(component, event, helper) {
        var page = 1
        var pageSize = component.find("pageSize").get("v.value");
        helper.getHosptalsData(component, page, pageSize);
    },
