...
({
    ...
    convertArrayOfObjectsToCSV: function (component, objectRecords, template, BidType) {
        ...
        if(BidType != "One Time Buy Good Dated Shelf Life for New Product Launch" && BidType != 'Platform OTB'){
        ...
        myMap.set("Finance Comments", "Phoenix_Finance_Comments__c");
         if(BidType != "One Time Buy Good Dated Shelf Life for New Product Launch" && BidType != 'Platform OTB'){
        myMap.set("Customer Service Approval", "Phoenix_Customer_Service_Status__c");
