({
    ...
    submitFor : function(component, event, helper) { 
        ...
        if(bidrecord.Phoenix_Reference_Contracts__c==null && bidType!='New Customer'){
        ...
        }else if(bidType == 'Sales Out Rebate' 
                 && (bidrecord.Phoenix_Sales_Out_Promotion_of_Days__c == null 
                     || bidrecord.Phoenix_Sales_Out_Promotion_of_Days__c == '' )){
            isBidNotValid= "Please Enter Sales Out Promotion # of Days";
        }else if(bidType == 'Sales Out Rebate' 
                 && (bidrecord.Phoenix_Proposed_Sales_Out_Promotion__c == null
                     || bidrecord.Phoenix_Proposed_Sales_Out_Promotion__c == '')){
            isBidNotValid="Please Enter Proposed Sales Out Promotion %";
        }else if((bidType == 'Product Addition' || bidType == 'New Product Launch' || bidType == 'Price Change') 
                 && (bidrecord.Phoenix_Proactive_Reactive__c== null || bidrecord.Phoenix_Proactive_Reactive__c == '')){
            isBidNotValid= "Please Select Proactive/Reactive";
        }else if((bidType == 'Product Addition' || bidType == 'New Product Launch' || bidType == 'RFP Bids') 
            ...
            isBidNotValid= "Please Select Initial Order Discount Type";
                 ...
                 && (bidrecord.Phoenix_Initial_Order_Discount_of_Days__c == null || bidrecord.Phoenix_Initial_Order_Discount_of_Days__c== '' 
                     || bidrecord.Phoenix_Initial_Order_Discount_of_Days__c == 0 ) 
                 && bidrecord.Phoenix_Initial_Order_Discount_Type__c != 'Not Applicable' && bidrecord.Phoenix_Initial_Order_Discount_Type__c != 'None'){
            ...
            isBidNotValid = InitialOrderDays == 0 ? 'Initial Order Discount # of Days must be greater than 0' : 'Please Enter Initial Order Discount # of Days';
                 ...
                 && (bidrecord.Phoenix_Proposed_Initial_Order_Discount__c == null || bidrecord.Phoenix_Proposed_Initial_Order_Discount__c== '' 
                     || bidrecord.Phoenix_Proposed_Initial_Order_Discount__c== 0) 
                 && bidrecord.Phoenix_Initial_Order_Discount_Type__c != 'Not Applicable' && bidrecord.Phoenix_Initial_Order_Discount_Type__c != 'None'){
            ...
            action.setCallback(this, function(response) 
                               {
                                   if(response.getState()=="SUCCESS"){
                                       ...
                                       for(var i=0;i<bidlines.length;i++){
                                           console.log('bidlines[i].Phoenix_Override_Current_Direct_Units__c :: '+bidlines[i].Phoenix_Override_Current_Direct_Units__c);
                                           console.log('bidlines[i].Phoenix_Current_Direct_Selling_Unit__c :: '+bidlines[i].Phoenix_Current_Direct_Selling_Unit__c);
                                          
                                           if(DirectCons.length>0 && 
                                              bidlines[i].Phoenix_Proposed_Direct_Selling_Unit__c==null && bidType!='Price Change'){
                                               qtyError='Please Enter Proposed Direct Units for '+bidlines[i].Phoenix_Product__r.Name;
                                               console.log('in Direct Selling Units');
                                               break;
                                           }
                                           if(indirectCons.length>0 
                                              && bidlines[i].Phoenix_Proposed_Indirect_Selling_Unit__c==null && bidType!='Price Change'){
                                               qtyError='Please Enter Proposed Indirect Units for '+bidlines[i].Phoenix_Product__r.Name;
                                               console.log('in Indirect Selling Units');
                                               break;
                                           }
                                           if(bidlines[i].Phoenix_Wholesaler_Diff_Price_Indirect__c==null 
                                              ...
                                              && bidType !='Sales Out Rebate'){
                                               qtyError='Please Enter Proposed Indirect Price for '+bidlines[i].Phoenix_Product__r.Name;
                                               console.log('wholesaler Price');
                                               break;
                                           }
                                           else if(component.get("v.isMarketingApprovePerson")==component.get("v.loggedInUserName") 
                                                   && bidlines[i].Phoenix_ProposedContractBidPriceMktng__c==null 
                                                   && (component.get("v.loggedInUserName")== bidlines[i].Phoenix_Product_Director1__c ||(delegatedUser != null && delegatedUser.includes(bidlines[i].Phoenix_Product_Director1__c)))
                                                   && bidType!='Customer Rebate Change' 
                                                   && bidType!='Volume Review Only'  
                                                   && bidType !='Sales Out Rebate' ){
                                               qtyError='Please Enter Proposed Direct Price for '+bidlines[i].Phoenix_Product__r.Name;
                                               console.log('marketing Price');
                                               break;
                                           }
                                               else if(component.get("v.isMarketingApprovePerson")==component.get("v.loggedInUserName") && 
                                                       bidlines[i].Phoenix_Customer_Dead_Net1__c != null){
                                                   if( (Math.round(parseFloat(bidlines[i].Phoenix_Wholesaler_Diff_Price_Indirect__c)*100)/100) < (Math.round(parseFloat(bidlines[i].Phoenix_Customer_Dead_Net1__c)*100)/100)
                                                      //&& parseFloat(bidlines[i].Phoenix_Wholesaler_Diff_Price_Indirect__c.toFixed(2)) > parseFloat(bidlines[i].Phoenix_Customer_Dead_Net1__c.toFixed(2))
                                                      && bidType!='Customer Rebate Change' 
                                                      && bidType!='Volume Review Only'  
                                                      && bidType !='Sales Out Rebate'){
                                                       qtyError='Proposed Indirect Price can not be less than Net Indirect Price for Product : '+bidlines[i].Phoenix_Product__r.Name;;
                                                       console.log('marketing Price');
                                                       break;
                                                   }
                                               }
                                       ...
                                       /*    else if (bidType == 'New Product Launch' && bidlines[i].Phoenix_Direct_Dead_Net__c < bidlines[i].Phoenix_Lowest_Price_SKU__c && bidlines[i].Phoenix_Direct_Dead_Net__c !=0 && (delegatedUser != null && delegatedUser.includes(bidlines[i].Phoenix_Product_Director1__c))){
                                        ...
                                        for(var i=0;i<bidlines.length;i++){
                                            if (bidType != 'New Product Launch' && ((bidlines[i].Phoenix_Override_Current_Indirect_Units__c == null || bidlines[i].Phoenix_Override_Current_Indirect_Units__c == 'undefined' || bidlines[i].Phoenix_Override_Current_Indirect_Units__c == undefined) && (bidlines[i].Phoenix_Current_Indirect_Selling_Unit__c == 0 || bidlines[i].Phoenix_Current_Indirect_Selling_Unit__c == undefined || bidlines[i].Phoenix_Current_Indirect_Selling_Unit__c == null))){
                                               isOverrideUnitsavl =true;
                                               break;
                                           }
                                           else if (bidType != 'New Product Launch' && ((bidlines[i].Phoenix_Override_Current_Direct_Units__c == null || bidlines[i].Phoenix_Override_Current_Direct_Units__c == 'undefined' || bidlines[i].Phoenix_Override_Current_Direct_Units__c == undefined) && (bidlines[i].Phoenix_Current_Direct_Selling_Unit__c == 0 || bidlines[i].Phoenix_Current_Direct_Selling_Unit__c == undefined || bidlines[i].Phoenix_Current_Direct_Selling_Unit__c == null))){
                                               isOverrideUnitsavl =true;
                                               break;
                                           }
                                        }
        ...
        action.setCallback(this, function(response) 
                           {
                               if(response.getState()=="SUCCESS"){
                                   ...
                                   console.log('iodType ######## '+bidRecord.Phoenix_Initial_Order_Discount_Type__c);
                                   console.log('iodDays ######## '+bidRecord.Phoenix_Initial_Order_Discount_of_Days__c);
                                   console.log('iodDiscount ######## '+bidRecord.Phoenix_Proposed_Initial_Order_Discount__c);
                                   ...
                                   /* if(iodType != null){
                                       ...
                                       bidRecord.Phoenix_Initial_Order_Discount_Type__c = 'None'; */
                                   component.set("v.IODType",iodType);
    ...
    /* iodTypeChange : function(component, event, helper){
        ...
        var iodDaysDomVar = component.find("iodDays");
        if(event.getSource().get("v.value")=='None' || event.getSource().get("v.value")==''){
            component.find("iodDays")[0].set("v.value",null);
            ...
            iodDays[]
            component.find(...).set is not function
        }       
    }, */
    ...
    onRecordSubmit : function(component, event, helper){
        ...
        if(slctCntrcts.length==0 && component.get("v.BidTypeVal")!='New Customer'){
            ...
            toastEvent.fire();
                 ...
                 && (eventFields["Phoenix_Sales_Out_Promotion_of_Days__c"] == null || eventFields["Phoenix_Sales_Out_Promotion_of_Days__c"] == '' || eventFields["Phoenix_Sales_Out_Promotion_of_Days__c"] == 0 )){
            ...
            toastEvent.fire();
                 ...
                 && (eventFields["Phoenix_Proposed_Sales_Out_Promotion__c"] == null || eventFields["Phoenix_Proposed_Sales_Out_Promotion__c"] == '' 
                     || eventFields["Phoenix_Proposed_Sales_Out_Promotion__c"] == 0) ){
            ...
            toastEvent.fire();
        }else if((bidType == 'RFP Bids' || bidType == 'Product Addition' || bidType == 'New Product Launch') 
                 && (eventFields["Phoenix_Initial_Order_Discount_Type__c"] == null || eventFields["Phoenix_Initial_Order_Discount_Type__c"] == '' || eventFields["Phoenix_Initial_Order_Discount_Type__c"]=='None')){
            var toastEvent = $A.get("e.force:showToast");
            toastEvent.setParams({
                "title": "Error!",
                "type":"error",
            ...
            toastEvent.fire();
                 ...
                 && (eventFields["Phoenix_Initial_Order_Discount_of_Days__c"] == null || eventFields["Phoenix_Initial_Order_Discount_of_Days__c"] == '' || eventFields["Phoenix_Initial_Order_Discount_of_Days__c"] == 0 ) 
                 && eventFields["Phoenix_Initial_Order_Discount_Type__c"] != 'Not Applicable' 
                 && eventFields["Phoenix_Initial_Order_Discount_Type__c"] != 'None'){
            ...
            toastEvent.fire();
                 ...
                 && (eventFields["Phoenix_Proposed_Initial_Order_Discount__c"] == null || eventFields["Phoenix_Proposed_Initial_Order_Discount__c"] == '' || eventFields["Phoenix_Proposed_Initial_Order_Discount__c"] == 0) 
                 && eventFields["Phoenix_Initial_Order_Discount_Type__c"] != 'Not Applicable' 
                 && eventFields["Phoenix_Initial_Order_Discount_Type__c"]!= 'None'){
            ...
            if(component.get("v.BidTypeVal")!='New Customer'){
                helper.getNPRDataOfContracts(component, event, helper,
                                             slctCntrcts,component.get("v.templateType"));
            }
        }
    },
