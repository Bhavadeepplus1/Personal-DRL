({    
    doInit: function(component, event, helper) {
        ...
        if(component.get("v.singleRec.Vision_CVS_Direct_Analysis_Vol__c") != null && component.get("v.singleRec.Vision_CVS_Direct_Analysis_Vol__c") != undefined)
            component.set("v.analysisCvsDirVol",component.get("v.singleRec.Vision_CVS_Direct_Analysis_Vol__c").toLocaleString('en-US'));//for analysis
    ...
    calcGoalSeek : function(component,event,helper){
        ...
        console.log('deadnetPrice--'+deadnetPrice);
         var wholesalerFee = parseFloat(component.get("v.singleRec.Phoenix_Whlsr_Controlled_Substance_Fee__c"));       
    ...
    calcCardDeadNetGoalSeek:  function(component,event,helper){
        ...
        component.set("v.expectMajorDdeadnet", '');
        var bidRecord=component.get("v.bidRecordParent");  
        var wholesalerFee = parseFloat((component.get("v.singleRec.Phoenix_Whlsr_Controlled_Substance_Fee__c")!= null && component.get("v.singleRec.Phoenix_Whlsr_Controlled_Substance_Fee__c") != undefined) ? component.get("v.singleRec.Phoenix_Whlsr_Controlled_Substance_Fee__c") : 0);
        ...
        let aboveCalc = cardDeadNetPrice + (currCD*wac) + (bidFeeMasterFeeNLC) + wholesalerFee;
    ...
    calcMajorDeadNetGoalSeek:  function(component,event,helper){
        ...
        let currCD = parseFloat(bidRecord.Phoenix_Current_CD__c/100);
        console.log('currCD :: '+currCD);
        console.log('additinal rebate :: '+bidRecord.Phoenix_AdditionalRebateCardinalMajor__c);
        let additionalRebatePer = parseFloat((bidRecord.Phoenix_AdditionalRebateCardinalMajor__c != null && bidRecord.Phoenix_AdditionalRebateCardinalMajor__c != undefined) ? bidRecord.Phoenix_AdditionalRebateCardinalMajor__c/100 : 0);//parseFloat(1/100);//
        console.log('additionalRebatePer :: '+additionalRebatePer);
        let wac = parseFloat(component.get("v.singleRec.Phoenix_WAC__c"));
        console.log('wac :: '+wac);
        ...
        console.log('belowCalc ::--> '+belowCalc);  
        let aboveCalc = majorDeadNetPrice + (currCD*wac) +wholesalerFee;//majorDeadNetPrice + (currCD + bidFeeMasterFeeNLC)*wac;
        console.log('aboveCalc ::--> '+aboveCalc);
