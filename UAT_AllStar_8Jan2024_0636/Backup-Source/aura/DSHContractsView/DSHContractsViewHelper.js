...
({
    ...
    convertArrayOfObjectsToCSV: function (component, objectRecords, template, BidType) {
        ...
        if(BidType != 'Volume Review Only'){
          myMap.set("Proposed BASE Contract Price", "Phoenix_Retail_Direct_Price__c");
          myMap.set("Proposed DSH Contract Price", "Phoenix_Retail_Indirect_Net__c");
          myMap.set("Proposed AutoSub Contract Price", "Phoenix_Retail_Indirect_Price__c");
        }
