                                       ...
                                       if(isApproved == true){
                                           ...
                                           if(isContracts){
                                               ...
                                               if(!component.get("v.winnabilityIgnored")){
                                                   ...
                                                   if(templateType=='Walgreens' && bidtype == 'RFP Bids' && ((approvalStatus.includes('SCM') && approvalStatus.includes('Marketing')) || bidRecord.Phoenix_Approval_Status__c == 'Marketing')){
                                                       ...
                                                       component.set("v.winnabilityIgnored", false);
