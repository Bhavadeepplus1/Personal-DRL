({
    doInit:function(component, event, helper){
       ...
       var child2RelatedList = component.get("v.record.child2RelatedList");
        ...
        child2RelatedList.forEach(function(rec){
            ...
            pFamilyList.push(rec.T2_revised_product_family__c);
	...
	handleClick1: function(component, event, helper){
       ...
       var child2RelatedList = component.get("v.record.child2RelatedList");
        ...
        var allData= [];
       child2RelatedList.forEach(function(rec){
           console.log('test child cmp2==>'+rec.T2_Contact_Description__c);
           if(contractmapObj.hasOwnProperty(rec.T2_Contact_Description__c)){
                 
               var relatedList = contractmapObj[rec.T2_Contact_Description__c];
               relatedList.push(rec);
               contractmapObj[rec.T2_Contact_Description__c] = relatedList;
