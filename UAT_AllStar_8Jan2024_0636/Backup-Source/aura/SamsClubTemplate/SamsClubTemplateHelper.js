({
        ...
        action.setCallback(this, function(response) 
                           {
                               if(response.getState()=="SUCCESS"){
                                   ...
                                   component.set("v.actualsales",responseValue[0].actualsales);
                                   component.set("v.overrideunits",responseValue[0].OverrideTotalUnits);
                                   ...
                                   component.set("v.indTp",responseValue[0].indTp);
                                   //
                                   component.set("v.TPTDollorTotal",responseValue[0].TputMargin);
                                   ...
                                   component.set("v.IndirectTP",responseValue[0].IndirectTP);
                                   var IndirectTPPercent = responseValue[0].intdead != 0 ? (responseValue[0].IndirectTP/responseValue[0].intdead)*100 : 0;
                                   component.set("v.IndirectTPPercent",IndirectTPPercent);
  ...
  if(bidType == "RFP Bids" || bidType == "Volume Review Only" || bidType == "Product Addition"){
       ...
       myMap.set("CM Fee %", "Phoenix_Contract_Mngment_Fee_Wholesaler__c");
       myMap.set("CM Fee", "Phoenix_Contract_Mngmnt_Fee_Wholesaler__c");
            ...
            if(value=='Phoenix_RCA_Agreement__r.Name'){*/
                      ...
                      csvStringResult += '"'+estleadtime+'"';
                       ...
                       csvStringResult += '"'+''+'"'; 
                            ...
                            if(latest_estimate != null){
                                ...
                                else if(value == 'Phoenix_TP_Margin__c'){
                                    var VIPPerUnitdl = objectRecords[i]['Phoenix_TP_Margin__c'];
                ...
                /* 
                   ...
                   // console.log("iodperunit--->"+iodperunit);
                    ...
                    csvStringResult += '"'+roundeiodperunit+'"';  
                    }
                    else{
                        csvStringResult += '"'+''+'"';
                    }      
                   ...
                   // console.log("internaldeadnetprice--->"+internaldeadnetprice);
                    ...
                    csvStringResult += '"'+roundeinternaldeadnetprice+'"';  
                    }
                    else{
                        csvStringResult += '"'+''+'"';
                    }         
                   ...
                   // console.log("customerdeadnet--->"+customerdeadnet);
                    ...
                    csvStringResult += '"'+roundecustomerdeadnet+'"';  
                    }
                    else{
                        csvStringResult += '"'+''+'"';
                    }       
                   ...
                   // console.log("rebateperindl--->"+rebateperindl);
                    ...
                    csvStringResult += '"'+rounderebateperindl+'"';  
                    }
                    else{
                        csvStringResult += '"'+''+'"';
                    }      
                   ...
                   console.log("iodtotalamount--->"+iodtotalamount);
                    ...
                    csvStringResult += '"'+roundeiodtotalamount+'"';  
                    }
                    else{
                        csvStringResult += '"'+''+'"';
                    }           
                  }*//*
               else if(value == 'Phoenix_Opening_Order_Net_sales__c'){
                                                                                                                       var cmfeeperunit = objectRecords[i]['Phoenix_Opening_Order_Net_sales__c'];
                                                                                                                       // console.log("cmfeeperunit--->"+cmfeeperunit);
                                                                                                                       if(cmfeeperunit != null){
                                                                                                                           var roundecmfeeperunit=Math.round((cmfeeperunit ) * 100) / 100
                                                                                                                           csvStringResult += '"'+Math.round(roundecmfeeperunit)+'"';  
                                                                                                                       }
                                                                                                                       else{
                                                                                                                           csvStringResult += '"'+''+'"';
                                                                                                                       }       
                                                                                                                   }
                                                                                                                       else if(value == 'Phoenix_Opening_Order_TPT__c'){
                                                                                                                           var cmfeeperunit = objectRecords[i]['Phoenix_Opening_Order_TPT__c'];
                                                                                                                           // console.log("cmfeeperunit--->"+cmfeeperunit);
                                                                                                                           if(cmfeeperunit != null){
                                                                                                                               var roundecmfeeperunit=Math.round((cmfeeperunit ) * 100) / 100
                                                                                                                               csvStringResult += '"'+Math.round(roundecmfeeperunit)+'"';  
                                                                                                                           ...
                                                                                                                           else if(value == 'Phoenix_Opening_Order_TPT_Per__c'){
                                                                                                                               var cmfeeperunit = objectRecords[i]['Phoenix_Opening_Order_TPT_Per__c'];
                                                                                                                               // console.log("cmfeeperunit--->"+cmfeeperunit);
                                                                                                                               if(cmfeeperunit != null){
                                                                                                                                   var roundecmfeeperunit=Math.round((cmfeeperunit ) * 100) / 100
                                                                                                                                   csvStringResult += '"'+roundecmfeeperunit+'"';  
        ...
        action.setCallback(this, function(response) 
                           {
                               if (response.getState() === "SUCCESS") {
                                   ...
                                   for(var i=0;i<resultlength;i++){	
                                       ...
                                       else if(component.get("v.BidAprrovalStatus")!='Draft' && ResultData[i].Phoenix_Product_Director__c==component.get("v.loggedInUserName") &&  ResultData[i].Phoenix_Wholesaler_Diff_Price_Indirect__c < ResultData[i].Phoenix_Customer_Dead_Net1__c && bidtype!='Customer Rebate Change' && bidtype!='Volume Review Only' && bidtype!='Sales Out Rebate'){	
                                           if(ResultData[i].Phoenix_Marketing_Approval__c !='Not Approved'){
