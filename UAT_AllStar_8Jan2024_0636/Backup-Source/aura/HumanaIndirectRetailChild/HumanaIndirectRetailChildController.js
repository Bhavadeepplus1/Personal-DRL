...
({
    doInit: function (component, event, helper) {
        ...
        if(singleRec.Latest_Line_Item__c != null && singleRec.Latest_Line_Item__c != '' && singleRec.Latest_Line_Item__c != undefined && singleRec.Latest_Line_Item__r.Phoenix_Bid__c != null){
            component.set("v.latestBidName",singleRec.Latest_Line_Item__r.Phoenix_Bid__r.Name);  
      		latestBidNames.push(component.get("v.latestBidName"))
           
        }*/
         //console.log('latestBidNames===>'+latestBidNames);
        //end by satya//
 ...
 // }
    ...
    inlineEditPCBP: function (component, event, helper) {
      ...
      //  console.log('modalstart---' + LineItemtable);
       ...
       //  console.log('Latest_Line_Item__====='+singleRec.Latest_Line_Item__c);
       //  console.log('Latest_Line_Item__ bid====='+singleRec.Latest_Line_Item__r.Phoenix_Bid__c);
       if(singleRec.Latest_Line_Item__c != null && singleRec.Latest_Line_Item__c != '' && singleRec.Latest_Line_Item__c != undefined && singleRec.Latest_Line_Item__r.Phoenix_Bid__c != null){
