            ...
            for(Phoenix_BidLineItemExtn__c bliExtObj : trigger.New){
                try{
                    ...
                    if(bliMap.containskey(bliExtObj.Phoenix_Bid_Line_Item__c)){
                        ...
                        if (blItem.Phoenix_SCM_Final_Approval__c != null && blItem.Phoenix_SCM_Final_Approval__c == true) {
                            system.debug('inside SCM true and assign for calcs');
...
blItem.Phoenix_Final_Indirect_Selling_Units_Cal__c  = inDirUnits;//proIndirTotalUnits != 0 ? proIndirTotalUnits : overrideIndirectUnits != 0 ? overrideIndirectUnits : blItem.Phoenix_Current_Indirect_Selling_Unit__c;
                        ...
                        //}
                      /*  if((bliExtObj.Phoenix_Bid_Line_Item__r.Phoenix_Product__r.Phoenix_Controlled_Substance__c  != null && bliExtObj.Phoenix_Bid_Line_Item__r.Phoenix_Product__r.Phoenix_Controlled_Substance__c == 'Yes') && bidRec.Phoenix_Customer__r.Name == 'Red Oak Sourcing' && (bidRec.Phoenix_Reference_Contracts__c.contains('3000000489') || bidRec.Phoenix_Reference_Contracts__c.contains('3000000753'))){
                        blItem.Phoenix_Whlsr_Controlled_Substance_Fee__c = (0.0041*blItem.Phoenix_Pkg_Size__c).setScale(4);
                    }     
                    else{
                        blItem.Phoenix_Whlsr_Controlled_Substance_Fee__c = null;
                    }*/
                        //Reduction
                        ...
                        system.debug('propBidPricing ::----> '+propBidPricing);
                        ...
                        Decimal cvsIndirectDeadNet = propBidPricing - 
                            bliExtObj.Phoenix_ZITD__c-	
                            indirCD-	
                            blItem.Phoenix_Contract_Mngmnt_Fee_Wholesaler__c-
                            rdc;
                        system.debug('cvsIndirectDeadNet :: '+cvsIndirectDeadNet);
                        ...
                        // //checked not null for Phoenix_Net_Price_after_Rebates_Terms__c,bliExtObj.Phoenix_CardinalAdditionalRebate__c, blItem.Phoenix_Whlsr_Controlled_Substance_Fee__c by satya
                        Decimal custDeadNet = (propCardinalPrice - indirCD - (blItem.Phoenix_Net_Price_after_Rebates_Terms__c != null ?blItem.Phoenix_Net_Price_after_Rebates_Terms__c :0) - nlcFee - (bliExtObj.Phoenix_CardinalAdditionalRebate__c != null ? bliExtObj.Phoenix_CardinalAdditionalRebate__c :0));
                                               if(bidRec.Phoenix_Reference_Contracts__c.contains('3000000489')){
                                                   custDeadNet = custDeadNet - (blItem.Phoenix_Whlsr_Controlled_Substance_Fee__c != null? blItem.Phoenix_Whlsr_Controlled_Substance_Fee__c :0);
                                               }
                        system.debug('propCardinalPrice-->'+propCardinalPrice);
                        system.debug('indirCD-->'+indirCD);
                        system.debug('nlcFee-->'+nlcFee);
                        system.debug('blItem.Phoenix_Net_Price_after_Rebates_Terms__c-->'+blItem.Phoenix_Net_Price_after_Rebates_Terms__c);
                        system.debug('bliExtObj.Phoenix_CardinalAdditionalRebate__c-->'+bliExtObj.Phoenix_CardinalAdditionalRebate__c);
                        system.debug('blItem.Phoenix_Whlsr_Controlled_Substance_Fee__c-->'+blItem.Phoenix_Whlsr_Controlled_Substance_Fee__c);
                        ...
                        system.debug('controlle==='+blItem.Phoenix_Whlsr_Controlled_Substance_Fee__c);
                        // Internal Major Dead Net 
                        // check Phoenix_Proposed_Major_Contract_Price__c is not null
                        // Satya checked not null for blItem.Phoenix_Net_Price_after_RebatesbeforeVIP__c,bliExtObj.Phoenix_Major_Additional_Rebate__c,blItem.Phoenix_Whlsr_Controlled_Substance_Fee__c
                                               Decimal majorDeadNet = propMajorPrice - 
                                               indirCD -
                                               (blItem.Phoenix_Net_Price_after_RebatesbeforeVIP__c != null ? blItem.Phoenix_Net_Price_after_RebatesbeforeVIP__c : 0) -
                                               (bliExtObj.Phoenix_Major_Additional_Rebate__c != null ? bliExtObj.Phoenix_Major_Additional_Rebate__c : 0);
                                               if(bidRec.Phoenix_Reference_Contracts__c.contains('3000000753')){
                                                   majorDeadNet= majorDeadNet - (blItem.Phoenix_Whlsr_Controlled_Substance_Fee__c != null ? blItem.Phoenix_Whlsr_Controlled_Substance_Fee__c : 0);
                                               }
                        ...
                        system.debug('initialOrderDisc  ::--> '+initialOrderDisc);
                        system.debug('initialOrderDays ::--> '+initialOrderDays);
                        ...
                        blItem.Phoenix_Net_Sales_Internal__c = bliExtObj.Phoenix_Major_Net_Sales__c + 
                            blItem.Phoenix_Wholesaler_Net_Sales__c +
                            bliExtObj.Phoenix_CVS_Total_Net_Sales__c;
                        // Total RedOak TPT $ 	 
                        bliExtObj.Phoenix_Total_RedOak_TPT__c = bliExtObj.Phoenix_CVS_Total_TPT__c + 
                            bliExtObj.Phoenix_Cardinal_TPT__c + 
                            bliExtObj.Phoenix_Major_TPT__c;
                        // Total RedOak TPT % 
...
counts.put('majorUnits',majorUnits);*/
                        ...
                        blItem.Phoenix_Proposed_Sales__c = blItem.Phoenix_Net_Sales_Internal__c;//(blItem.Phoenix_Internal_Dead_Net_Price__c != null ? blItem.Phoenix_Internal_Dead_Net_Price__c : 0) * (finalTotalUnits);
                        
                        //Price and Volume Variance Calculations --- added by Jogarao
                        Decimal diffinVolumeCVSDirect  = ( blItem.Phoenix_SCM_Final_Approval__c == true  ? scmApprovedDirUnits :proDirUnits ) - ((overrideCurrentDir >0 || overrideTotalUnits>0) ? overrideCurrentDir :retailDirUnits );
                        Decimal diffinVolumeCVSIndirect  = ( blItem.Phoenix_SCM_Final_Approval__c == true ? scmApprovedIndirUnits :proIndirUnits ) - ((overrideCurrentIndir >0 || overrideTotalUnits>0) ? overrideCurrentIndir :retailIndirUnits );
                        Decimal diffinVolumeCardinal  = ( blItem.Phoenix_SCM_Final_Approval__c == true ? scmCardinalUnits :proCardinalUnits  ) - ((overrideCard >0 || overrideTotalUnits>0) ? overrideCard :wholesaleUnits );
                        Decimal diffinVolumeMajor  = ( blItem.Phoenix_SCM_Final_Approval__c == true ? scmMajorUnits :proMajorUnits  ) - ((overrideMajor >0 || overrideTotalUnits>0) ? overrideMajor :anual3MonMajorUnits );
                        
                        Decimal diffinCVSDirDeadNet = (blItem.Phoenix_Direct_Dead_Net__c!= null ? blItem.Phoenix_Direct_Dead_Net__c :0) - (blItem.Phoenix_DeadNet_TrckGR__c  != null ? blItem.Phoenix_DeadNet_TrckGR__c  : 0);
                        Decimal diffinCVSIndirDeadNet = (blItem.Phoenix_Indirect_Dead_Net__c != null ? blItem.Phoenix_Indirect_Dead_Net__c  :0) - (blItem.Phoenix_DeadNet_TrckGR__c  != null ? blItem.Phoenix_DeadNet_TrckGR__c  : 0);
                        Decimal diffinCardinalDirDeadNet = (blItem.Phoenix_Customer_Dead_Net1__c != null ? blItem.Phoenix_Customer_Dead_Net1__c  :0) - (blItem.Phoenix_DeadNet_TrckGR__c  != null ? blItem.Phoenix_DeadNet_TrckGR__c  : 0);
                        Decimal diffinMajorDirDeadNet = (bliExtObj.Phoenix_Internal_Major_Dead_Net__c != null ? bliExtObj.Phoenix_Internal_Major_Dead_Net__c  :0) - (blItem.Phoenix_DeadNet_TrckGR__c  != null ? blItem.Phoenix_DeadNet_TrckGR__c  : 0);
                        
                        Decimal volumeVarianceCVSDir = diffinVolumeCVSDirect * diffinCVSDirDeadNet;
                        Decimal volumeVarianceCVSIndir = diffinVolumeCVSIndirect * diffinCVSIndirDeadNet;
                        Decimal volumeVarianceCardinal = diffinVolumeCardinal * diffinCardinalDirDeadNet;
                        Decimal volumeVarianceMajor = diffinVolumeMajor * diffinMajorDirDeadNet;
                        
                        Decimal priceVariCVSDir = diffinCVSDirDeadNet *((overrideCurrentDir > 0 || overrideTotalUnits>0) ? overrideCurrentDir : retailDirUnits);
                        Decimal priceVariCVSIndir = diffinCVSIndirDeadNet *((overrideCurrentIndir > 0 || overrideTotalUnits>0) ? overrideCurrentIndir : retailIndirUnits);
                        Decimal priceVariCardinal = diffinCardinalDirDeadNet *((overrideCard >0 || overrideTotalUnits>0) ? overrideCard :wholesaleUnits );
                        Decimal priceVariMajor = diffinMajorDirDeadNet *((overrideMajor >0 || overrideTotalUnits>0) ? overrideMajor :anual3MonMajorUnits );
                        blItem.Phoenix_Price_Variance__c = (bidType == 'Sales Out Rebate' || bidType == 'RFP Bids' ||  bidType == 'Price Change' || bidType == 'Customer Rebate Change') ? (priceVariCVSDir + priceVariCVSIndir+priceVariCardinal+priceVariMajor):0;
                        blItem.Phoenix_Volume_Variance__c = (bidType == 'Sales Out Rebate' || bidType == 'Price Change' || bidType == 'Customer Rebate Change') ? 0 : (volumeVarianceCVSDir + volumeVarianceCVSIndir+volumeVarianceCardinal+volumeVarianceMajor) ;  
                            
                            // SSA Hit Calculation 
                            
                            Decimal DiffPrice = (bliExtObj.Phoenix_Proposed_CvsDirectContractPrice__c != null ? bliExtObj.Phoenix_Proposed_CvsDirectContractPrice__c:0) - (blItem.Phoenix_Current_Direct_Price__c!= null ? blItem.Phoenix_Current_Direct_Price__c : 0);
                        Decimal SSANoofDays = (bidRec.Phoenix_Proposed_SSA_No_of_Days__c != null ? bidRec.Phoenix_Proposed_SSA_No_of_Days__c :0)/30;
                        blItem.Phoenix_SSA_Hit_Updated__c = DiffPrice * SSANoofDays * (((overrideCurrentDir >0 || overrideTotalUnits>0) ? overrideCurrentDir :retailDirUnits )/12);
