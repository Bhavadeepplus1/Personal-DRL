({
    ...
    showModel: function(component, event, helper) {
        ...
        $A.util.removeClass(LineItemtable, "detailTable");
    ...
    saveDetails : function(component, event, helper) {
        ...
        var LineItemtable = component.find("LineTable");
        $A.util.addClass(LineItemtable, "detailTable");
    ...
    downloadCsv : function(component,event,helper){    
        ...
        action.setCallback(this, function(a) {
            ...
            hiddenElement.download = 'Detail View'+'-'+bidNumber+'-'+bidName+'-'+Now+'.csv';  // CSV file Name* you can change it.[only name not .csv] 
