({
    ...
    doInit: function(component, event, helper){
        ...
        if(category == 'Business Lost'){
            ...
            var totalCurrentQuarterImpact = 0;
            var totalPrice = 0;
            var totalQty = 0;
            var obj ={};
            for(var i=0; i<record[1].length; i++){
                ...
                if(record[1][i].currentQuarterImpact != null)
                    totalCurrentQuarterImpact += record[1][i].currentQuarterImpact;
                else
                    totalCurrentQuarterImpact += 0;
            ...
            obj.totalCurrentQuarterImpact = totalCurrentQuarterImpact;
