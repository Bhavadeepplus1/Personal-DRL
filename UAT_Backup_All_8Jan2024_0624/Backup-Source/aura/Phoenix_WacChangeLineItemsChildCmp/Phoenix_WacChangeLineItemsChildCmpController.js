({
    ...
    inlineEditAwrdQty : function(component,event,helper){   
     ...
     inlineEditVistexDate : function(component,event,helper){   
        // show the name edit field popup 
        component.set("v.VistexDateEditMode", true); 
        // after the 100 millisecond set focus to input field   
         
        setTimeout(function(){ 
            component.find("VistexDate").focus();
        }, 100);
         //component.set("v.showSaveCancelBtn",true); 
    },
    inlineEditSCMRemarks : function(component,event,helper){   
     ...
     inlineEditOfferLetterSent : function(component,event,helper){   
        // show the name edit field popup 
        component.set("v.OfferLetterSentEditMode", true); 
        // after the 100 millisecond set focus to input field   
        setTimeout(function(){ 
            component.find("OfferLetterSent").focus();
        }, 100);
         //component.set("v.showSaveCancelBtn",true); 
    },
    ...
    onRatingChange : function(component,event,helper){ 
        ...
        component.set("v.AwrdQtyEditMode", false);
         ...
         component.set("v.VistexDateEditMode", false);
        component.set("v.showSaveCancelBtn",true);
    },     
    ...
    closeNameBox : function (component, event, helper) {
      // on focus out, close the input section by setting the 'nameEditMode' att. as false   
        ...
        component.set("v.OfferLetterSentEditMode", false); 
