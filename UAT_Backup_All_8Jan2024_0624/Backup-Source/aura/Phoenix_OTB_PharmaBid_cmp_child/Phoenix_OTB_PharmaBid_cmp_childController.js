({    
    ...
    otbDirIndirChanged : function(component, event, helper){
        var indirUnits = component.get("v.singleRec.Phoenix_Proposed_Indirect_Selling_Unit__c") > 0 ? component.get("v.singleRec.Phoenix_Proposed_Indirect_Selling_Unit__c") : null;
        var dirUnits = component.get("v.singleRec.Phoenix_Proposed_Direct_Selling_Unit__c") > 0 ? component.get("v.singleRec.Phoenix_Proposed_Direct_Selling_Unit__c") : null;
        var dirPrice = component.get("v.singleRec.Phoenix_ProposedContractBidPriceMktng__c") > 0 ? component.get("v.singleRec.Phoenix_ProposedContractBidPriceMktng__c") : null;
        var indirPrice = component.get("v.singleRec.Phoenix_Wholesaler_Diff_Price_Indirect__c") > 0 ? component.get("v.singleRec.Phoenix_Wholesaler_Diff_Price_Indirect__c") : null;
        
        component.set("v.singleRec.Phoenix_Proposed_Direct_Selling_Unit__c",dirUnits);
        component.set("v.singleRec.Phoenix_Proposed_Indirect_Selling_Unit__c",indirUnits);
        component.set("v.singleRec.Phoenix_ProposedContractBidPriceMktng__c",dirPrice);
        component.set("v.singleRec.Phoenix_Wholesaler_Diff_Price_Indirect__c",indirPrice);
        //component.set("v.CDSUTotal",null);
        //component.set("v.CISUTotal",null);
        
       /* var otbDirIndirect = component.get("v.otbDirIndirect");
        if(otbDirIndirect == 'Direct'){
            component.set("v.singleRec.Phoenix_Proposed_Indirect_Selling_Unit__c",null);
        }
        else if(otbDirIndirect == 'Indirect'){
    ...
    inlineEditProDirContr : function(component,event,helper){  
     ...
     inlineEditInventoryUnits : function(component,event,helper){  
        component.set("v.InventoryUnitsEditMode", true);
        setTimeout(function(){
            component.find("InventoryUnits").focus();
        }, 100);
    },
    ...
    inlineEditCustServUpdateComments : function(component,event,helper){  
        component.set("v.CustServUpdateCommentsEditMode", true);
        setTimeout(function(){
            component.find("CustServUpdateComments").focus();
        }, 100);
    },
    
    inlineEditCustServUpdateApproval : function(component,event,helper){  
        component.set("v.CustServUpdateApprovalEditMode", true);
        setTimeout(function(){
            component.find("CustServUpdateApprovalId").focus();
        }, 100);
    },
    ...
    calcGoalSeek : function(component,event,helper){
        ...
        let vipPercent = component.get("v.singleRec.Phoenix_Bid__r.Phoenix_Proposed_Value_Est_VIP__c") != undefined ? parseFloat(component.get("v.singleRec.Phoenix_Bid__r.Phoenix_Proposed_Value_Est_VIP__c")/100) : 0;
        
        console.log('=======vipPercent=========='+vipPercent);
        let directDeadNet= component.get("v.singleRec.Phoenix_Direct_Dead_Net__c") != undefined ? parseFloat(component.get("v.singleRec.Phoenix_Direct_Dead_Net__c")) : 0;
        console.log('=======directDeadNet=========='+directDeadNet);
        let pur= component.get("v.singleRec.Phoenix_Proposed_Per_Unit_Rebate__c") != undefined ? parseFloat(component.get("v.singleRec.Phoenix_Proposed_Per_Unit_Rebate__c")) : 0;
        console.log('=======pur=========='+pur);
        let vip= component.get("v.singleRec.Phoenix_Wholesaler_VIP__c") != undefined ? parseFloat(component.get("v.singleRec.Phoenix_Wholesaler_VIP__c")) : 0;
        console.log('=======vip=========='+vip);
        
        let rebFeesPercent = component.get("v.singleRec.Phoenix_Proposed_Current_Rebate__c") != undefined ? parseFloat(component.get("v.singleRec.Phoenix_Proposed_Current_Rebate__c")/100) : 0;
    ...
    calcIndirectDeadNetGoalSeek:  function(component,event,helper){
        ...
        let pur = component.get("v.singleRec.Phoenix_Proposed_Per_Unit_Rebate__c") != undefined ? component.get("v.singleRec.Phoenix_Proposed_Per_Unit_Rebate__c") : 0;
        console.log('pur-->'+pur);
        ...
        proposedcashterms = proposedcashterms!=null ? proposedcashterms=parseFloat(proposedcashterms/100) : 0;
        console.log('proposedcashterms-->'+proposedcashterms);
        var WAC = component.get("v.singleRec.Phoenix_WAC__c") != undefined ? component.get("v.singleRec.Phoenix_WAC__c") : 0;
        console.log('WAC-->'+WAC);
        let rdcperc = component.get("v.singleRec.Phoenix_RDC_NLC__c") != undefined ? parseFloat(component.get("v.singleRec.Phoenix_RDC_NLC__c")/100) : 0;
        console.log('rdcperc-->'+rdcperc);
        let rebate_feeperc = component.get("v.singleRec.Phoenix_Proposed_Current_Rebate__c")!=undefined ? parseFloat(component.get("v.singleRec.Phoenix_Proposed_Current_Rebate__c")/100) : 0;
        console.log('rebate_feeperc-->'+rebate_feeperc);
        let vipperc= component.get("v.singleRec.Phoenix_Bid__r.Phoenix_Proposed_Value_Est_VIP__c") != undefined ? parseFloat(component.get("v.singleRec.Phoenix_Bid__r.Phoenix_Proposed_Value_Est_VIP__c")/100) : 0;
        console.log('vipperc-->'+vipperc);
        let cmfeeperc = component.get("v.singleRec.Phoenix_Contract_Mngment_Fee_Wholesaler__c") != undefined ? parseFloat(component.get("v.singleRec.Phoenix_Contract_Mngment_Fee_Wholesaler__c")/100) : 0;
            ...
            fieldName = nameofEditfield;
                ...
                fieldName = nameofEditfield;
                    ...
                    fieldName = nameofEditfield;
                        ...
                        else if(nameofEditfield == 'CustServUpdateApproval'){
                            currentValue = val;
                            fieldName = nameofEditfield;
                        }
                        else{
    ...
    closeInventoryUnits: function (component, event, helper) {
        component.set("v.InventoryUnitsEditMode", false);
        
    },
    closeCustServUpdateApprovalBox : function (component, event, helper) {
        component.set("v.CustServUpdateApprovalEditMode", false);
    },
    closeCustServUpdateComments: function (component, event, helper) {
        component.set("v.CustServUpdateCommentsEditMode", false);
