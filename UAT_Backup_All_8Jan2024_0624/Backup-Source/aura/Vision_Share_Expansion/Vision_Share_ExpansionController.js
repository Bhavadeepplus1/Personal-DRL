({
    doInit : function(component, event, helper) {
        ...
        action.setParams({accId : accId,picliList:picliList, showAllData : component.get("v.isAllPanoramaTasks")});
        action.setCallback(this, function (response) {
            ...
            if (response.getState() == "SUCCESS") {
                ...
                if(wrapperList[0].doesChildAccExist)
                    component.set("v.showToggleOfAllItems",true);
    ...
    searchTaskStatus : function(component, event, helper){
        ...
        if(component.get("v.isAllPanoramaTasks") && !picliList.includes('Show All Panorama Records')){
            picliList.push('Show All Panorama Records');
        }
        ...
        if(component.get("v.isAllPanoramaTasks") == false && picliList.includes('Show All Panorama Records')){
            var ind = picliList.indexOf('Show All Panorama Records')
            picliList.splice(ind, 1);
        }
