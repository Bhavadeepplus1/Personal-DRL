({
    ...
    formatFullCalendarData : function(component,events) {
       ...
       var currentDatePlusFive = new Date();
        ...
        for(var i = 0;i < events.length;i++){
            var startdate = events[i].CreatedDate__c != null ? $A.localizationService.formatDateTime(events[i].CreatedDate__c):null;
            var enddate = events[i].CompletedDate__c != null ? $A.localizationService.formatDateTime(events[i].CompletedDate__c):null;
            var startDateTime = events[i].CreatedDate__c != null ? $A.localizationService.formatDateTime(events[i].CreatedDate__c):null;
            var endDateTime = events[i].CompletedDate__c != null ? $A.localizationService.formatDateTime(events[i].CompletedDate__c):null;
          
            console.log('test-->'+events[i].Status)
           if (events[i].Status__c == 'Completed') {
                    console.log('inside Event');
                     console.log('start date time-->'+events[i].CreatedDate__c);
                    //nextDayThreshold: '20:00:00',
                    josnDataArray.push({
                         title:events[i].Job_Name__c,
                        'allDay':false,
                        'backgroundColor': "rgb(0,128,0)",// navy blue
                        'id':events[i].id,
                        ...
                        completeddate:events[i].Job_Completed_Date__c,
                        ...
                        jobduration:events[i].Job_Duration__c,
               ...
               else if (events[i].Status__c == 'Aborted') {
                    console.log('inside Event');
                     console.log('start date time-->'+events[i].CreatedDate__C);
                    //nextDayThreshold: '20:00:00',
                    josnDataArray.push({
                         title:events[i].Job_Name__c,
                        'allDay':false,
                        'backgroundColor': "rgb(255,215,0)",// navy blue
                        'id':events[i].id,
                        icon: '/resource/1653551355000/AccountCalender_T',
                 ...
                 //Failure==> The status of the job
               else if (events[i].Status__c == 'Failed') {
                    console.log('inside Event');
                     console.log('start date time-->'+events[i].CreatedDate__c);
                    //nextDayThreshold: '20:00:00',
                    josnDataArray.push({
                         title:events[i].Job_Name__c,
                        'allDay':false,
                        'backgroundColor': "rgb(255,69,0)",// navy blue
                        'id':events[i].id,
                        icon: '/resource/1653551355000/AccountCalender_T',
           ...
           //Processing==> The status of the job
               else if (events[i].Status__c == 'Processing') {
                    console.log('inside Event');
                     console.log('start date time-->'+events[i].CreatedDate__c);
                    //nextDayThreshold: '20:00:00',
                    josnDataArray.push({
    ...
    fetchCalenderEvents : function(component,event, element, view) {
        ...
        var action=component.get("c.getApeSyncObjAll");
        action.setParams({ 
