({
   ...
   convertArrayOfObjectsToCSV : function(component,objectRecords,template,bidType,isReBid,isScmapproved){
       ...
       if(bidType == "RFP Bids" || bidType == "New Product Launch"|| bidType == "Product Addition" || bidType=="Volume Review Only"){
           if(bidType == "RFP Bids" || bidType == "Product Addition" || bidType=="Volume Review Only"){
       ...
       }else if(bidType != "Price Change" && bidType != "New Product Launch"){
       ...
       if(bidType!='New Product Launch'){
           ...
           myMap.set("Current Mac and OS Net Sales", "Phoenix_Wholesaler_Net_Sales__c");
       ...
       myMap.set("TPT % Margin", "Phoenix_Retail_Direct_DRL_TPT_Percent__c");
       if(bidType == "RFP Bids" || bidType == "Product Addition" || bidType == "New Product Launch" ){
       ...
       for(var i=0; i < objectRecords.length; i++){  
           ...
           for (let [key, value] of myMap) {
                ...
                else if(value == 'Phoenix_Proposed_OS_Units__c1'){
              ...
              /* else if(value == 'Phoenix_Total_SCM_Approved_Qty__c' || value == 'Phoenix_Estimated_Lead_Time_Days__c' ||value == 'Phoenix_SCM_Approval_Y_N__c'||value == 'Phoenix_SCM_Notes__c'){
        ...
        action.setCallback(this, function(response) 
                           {
                               if (response.getState() === "SUCCESS") {
                                   ...
                                   for(var i=0;i<resultlength;i++){
                                       ...
                                       if( (isMacRADContract || isMacOSContract) && component.get("v.BidAprrovalStatus")!='Draft' && ResultData[i].Phoenix_Product_Director__c==component.get("v.loggedInUserName") && ResultData[i].Phoenix_Proposed_McK_OS_And_RAD_NCP__c==null && bidtype != 'Customer Rebate Change' && bidtype != 'Volume Review Only' && bidtype != 'Sales Out Rebate' ){	
                                      ...
                                      else if( isWMTIndirectContract && component.get("v.BidAprrovalStatus")!='Draft' && ResultData[i].Phoenix_Product_Director__c==component.get("v.loggedInUserName") && ResultData[i].Phoenix_Proposed_WMT_Indirect_NCP__c==null && bidtype != 'Customer Rebate Change' && bidtype != 'Volume Review Only' && bidtype != 'Sales Out Rebate' ){	
                                           if(ResultData[i].Phoenix_Marketing_Approval__c !='Not Approved'){
                                       ...
                                       else if(isWMRDirectContract && component.get("v.BidAprrovalStatus")!='Draft' && ResultData[i].Phoenix_Product_Director__c==component.get("v.loggedInUserName") && ResultData[i].Phoenix_Proposed_WMT_Direct_NCP__c==null && bidtype != 'Customer Rebate Change' && bidtype != 'Volume Review Only' && bidtype != 'Sales Out Rebate' ){	
                                           if(ResultData[i].Phoenix_Marketing_Approval__c !='Not Approved'){
