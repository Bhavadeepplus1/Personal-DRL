({
    ...
    getCalculations : function(component,event,helper, currentValue, fieldName,isGuidancePrice,isMarketingPrice,isSalesPrice){  
        ...
        var proposedIndirect = LineItem.Phoenix_Wholesaler_Diff_Price_Indirect__c;
        ...
        if((WAC < proposedPriceSales || WAC < proposedPriceMarketing  ) && !isGuidancePrice && (isMarketingPrice || isSalesPrice)){
        ...
        else if(WAC<proposedIndirect && bidType!='Volume Review Only'){
            var toastEvent = $A.get("e.force:showToast");
            toastEvent.setParams({
                "type":"Error",
                "title": "Error",
