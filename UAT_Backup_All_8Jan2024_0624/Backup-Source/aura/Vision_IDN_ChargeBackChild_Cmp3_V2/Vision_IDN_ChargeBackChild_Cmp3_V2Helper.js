({
	 getAllTotalsforIndividual : function(component,event,helper) {
        ...
        console.log('child2Name'+component.get("v.record.child2Name"));
        ...
        action.setParams({
         ...
         action.setCallback(this,function(response){
             ...
             if(response.getState() == 'SUCCESS'){
                 ...
                 component.set("v.twmonthsSalesTotal",Math.round(((totalsResponse[0].salesPrice) + Number.EPSILON) * 100) / 100)//totalsResponse[0].salesPrice
