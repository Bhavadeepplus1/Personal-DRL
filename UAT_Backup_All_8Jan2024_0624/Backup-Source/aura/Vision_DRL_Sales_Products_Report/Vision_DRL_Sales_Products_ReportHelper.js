({
    getData: function(component, event, helper,showInt){
        console.log('show Int in getdata-->'+showInt);
        console.log('searchText in getdata-->'+ component.get("v.searchText"));
        console.log('show tpt value-->'+component.get("v.showTPT"))
        ...
        console.log('accCode:: '+component.get("v.accCode"));
        ...
        action.setParams({
            ...
            accCode: component.get("v.accCode"),
            showInt:component.get("v.showTPT"),
        ...
        action.setCallback(this, function(response) 
                           {
                               if(response.getState()=="SUCCESS"){
                                  ...
                                  // component.set("v.keySet", response.keySet);
                                   ...
                                   console.log('recentLastMonth in product-->'+component.get("v.recentLastMonth"))
                                   console.log('previousLastMonth in product-->'+component.get("v.previousLastMonth"))
    ...
    buildData : function(component, event, helper, response) {
        ...
        console.log('Customer Ids length::: '+productFamilies.length);
