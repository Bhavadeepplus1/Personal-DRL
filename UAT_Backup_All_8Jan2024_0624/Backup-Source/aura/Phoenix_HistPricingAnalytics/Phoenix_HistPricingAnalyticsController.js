({
    ...
    doInit:function (component, event, helper) {
        ...
        $A.util.removeClass(LineItemtable, "slds-form-element__control");
    ...
    closeHistPricing:function(component,event,helper){
        component.set("v.displayHistPricing",false); 
         var LineItemtable = component.get("v.tableRef");
    ...
    filerChange : function(component,event,helper){
        var LastNMonths=component.find("lastMonths").get("v.value");
        if(LastNMonths=='Last 12 Months'){
            helper.Filter12Mts(component,event,helper);  
        }
        else{
            helper.Filter24Mts(component,event,helper);
        }
    }
})