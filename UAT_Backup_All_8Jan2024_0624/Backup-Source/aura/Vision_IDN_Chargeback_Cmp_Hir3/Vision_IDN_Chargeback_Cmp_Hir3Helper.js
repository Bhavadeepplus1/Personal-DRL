({
	...
	getFullData : function(component, event, helper) {
      ...
      gettwMonthsData : function(component, event, helper) {
        //var salesTerritory =  component.get("v.salesTerritory");
        console.log('selectedCategory12 hir3==??'+component.get("v.selectedcategory3"));
        console.log('selected values12 hir3...'+JSON.stringify(component.get("v.selectedValues")));
      console.log('in gettwMonthsData hir3');
      component.set("v.isSpinnerLoad", true);
