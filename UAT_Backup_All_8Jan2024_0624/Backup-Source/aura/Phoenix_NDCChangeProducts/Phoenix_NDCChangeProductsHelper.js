                               ...
                               if(response.getState()=="SUCCESS"){
                                   ...
                                   if(resp.length > 0){
                                       for(var i=0; i<resp.length; i++){
                                           ...
                                           //satya changed respData to resp for account contract current npr
                                           if(resp[i].hasOwnProperty('Phoenix_Account__r')){
                                               respVar.Account = resp[i].Phoenix_Account__r.Name;   
                                           }
                                           if(resp[i].hasOwnProperty('Phoenix_Contract__r')){
                                               respVar.Contract = resp[i].Phoenix_Contract__r.Name;
                                           }
                                           if(resp[i].hasOwnProperty('Phoenix_Current_NPR__r')){
        ...
        action.setCallback(this, function(response) {
            ...
            if (state == "SUCCESS") {
                ...
                for(var i = 0; i < respData.length; i++){
                    ...
                    if(respData[i].hasOwnProperty('Phoenix_Account__r')){
                     	resp.Account = respData[i].Phoenix_Account__r.Name;   
                    }
                    if(respData[i].hasOwnProperty('Phoenix_Contract__r')){
                    ...
                    if(respData[i].hasOwnProperty('Phoenix_Product__r')){
