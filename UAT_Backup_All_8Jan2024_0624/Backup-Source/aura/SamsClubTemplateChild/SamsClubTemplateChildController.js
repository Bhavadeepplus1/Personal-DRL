({    
        doInit: function(component, event, helper) { 
            ...
            if(component.get("v.singleRec.Phoenix_Wholesaler_Diff_Price_Indirect__c") > 0 && component.get("v.singleRec.Phoenix_Wholesaler_Diff_Price_Indirect__c") != null && component.get("v.singleRec.Phoenix_Wholesaler_Diff_Price_Indirect__c") != '' && component.get("v.singleRec.Phoenix_Wholesaler_Diff_Price_Indirect__c") != undefined){
                ...
                var wacPercent = (component.get("v.singleRec.Phoenix_WAC__c")/component.get("v.singleRec.Phoenix_Wholesaler_Diff_Price_Indirect__c")*100).toFixed(2)+'%';
                var currentContractPrice = (component.get("v.singleRec.Phoenix_Current_Indirect_Price__c")/component.get("v.singleRec.Phoenix_Wholesaler_Diff_Price_Indirect__c")*100).toFixed(2)+'%';
            }
            else{
                wacPercent = 'NA'; 
    ...
    //upto here
        ...
        calcGoalSeek : function(component,event,helper){
            ...
            let currentcashterms = bidRecord.Phoenix_Current_CD__c != null ? bidRecord.Phoenix_Current_CD__c : 0;
           ...
           component.set("v.RequiredPrice",requiredPriceNumer/(1-currentcashterms));
