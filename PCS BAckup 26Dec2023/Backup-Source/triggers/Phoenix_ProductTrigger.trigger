trigger Phoenix_ProductTrigger on Product2 (before insert, before update,after insert,after update) {
    ...
    for (Product2 obj: trigger.new){
        ...
        if((ndc!=null) && (ndc.startsWith('55111') || ndc.startsWith('43598') || ndc.startsWith('51862') || ndc.startsWith('68308') || ndc.startsWith('30142') || ndc.startsWith('70000') || ndc.startsWith('51316') || ndc.startsWith('11822') || ndc.startsWith('70677')|| ndc.startsWith('79903'))){
