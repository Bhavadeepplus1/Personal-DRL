...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>Account Category - 0</fullName>
        <actions>
        ...
        <active>false</active>
        <criteriaItems>
            <field>Account.SFDC_ID__c</field>
    ...
    <rules>
        <fullName>Account Category - 1</fullName>
        <actions>
    ...
    <rules>
        <fullName>Account Category - 2</fullName>
        <actions>
    ...
    <rules>
        <fullName>Account Category - 3</fullName>
        <actions>
    ...
    <rules>
        <fullName>Account Category - 4</fullName>
        <actions>
    ...
    <rules>
        <fullName>Account Category - 5</fullName>
        <actions>
    ...
    <rules>
        <fullName>Account Category - 6</fullName>
        <actions>
            <name>Category_6</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <criteriaItems>
