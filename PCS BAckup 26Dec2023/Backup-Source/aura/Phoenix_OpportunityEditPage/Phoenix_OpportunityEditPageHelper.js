        ...
        if (recordId != null && recordId != undefined && recordId != '') {
            ...
            action.setCallback(this, function (response) {
                ...
                if (state === "SUCCESS") {
                    ...
                    var optyProdList = wrapperObject.optyLineItems;
                    component.set("v.optyProdList",optyProdList);
    ...
    readDataFromUploadedFile: function(component, event, helper, offsetVal, headerMap){
        ...
        action.setCallback(this, function (response) {
            ...
            if (state === "SUCCESS") {
                ...
                console.log('returnDataList ---> '+JSON.stringify(returnDataList));
                console.log('returnDataList.length ---> '+returnDataList.length);
                var addedData = component.get("v.totalData");
                console.log('addedData.length BEFORE ---> '+addedData.length);
                returnDataList.forEach(function(retObj){addedData.push(retObj);});
                console.log('addedData.length after---> '+addedData.length);
