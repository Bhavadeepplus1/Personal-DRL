({
    ...
    submitFor : function(component, event, helper) { 
        ...
        if( bidType == 'Platform OTB' && (component.get("v.bidRecord.Phoenix_OTB_Marketing_Approver__c") == null || component.get("v.bidRecord.Phoenix_OTB_Marketing_Approver__c") == undefined)){
            isBidNotValid= "Please Select Marketing Approver before submitting the Bid.";   
        }
     ...
     /*   else if(loadtocontract != 'Yes' && loadtocontract != 'No'){
        ...
        if(isBidNotValid){
            ...
            console.log('delegatedUser-->'+delegatedUser)
            ...
            action.setCallback(this, function(response) {
                if(response.getState()=="SUCCESS"){
                    ...
                    console.log('bidType Inside response  :: '+bidType);
                    ...
                    for(var i=0;i<bidlines.length;i++){
                        ...
                        if(bidType == 'Platform PO OTB'){
                            if(component.get("v.BidAprrovalStatus")=='Draft' && ((bidlines[i].Phoenix_ProposedContractBidPriceMktng__c==null || bidlines[i].Phoenix_ProposedContractBidPriceMktng__c == undefined)&& otbDirIndirect=='Direct')){
                                qtyError='Please Enter Proposed Direct Contract Price (Marketing) for '+bidlines[i].Phoenix_Product__r.Name;	
                                break;	  
                            }
                            if(component.get("v.BidAprrovalStatus")=='Draft' && ((bidlines[i].Phoenix_Wholesaler_Diff_Price_Indirect__c==null || bidlines[i].Phoenix_Wholesaler_Diff_Price_Indirect__c == undefined) && otbDirIndirect=='Indirect')){
                                qtyError='Please Enter Proposed Indirect Contract Price (Marketing) for '+bidlines[i].Phoenix_Product__r.Name;	
                                break;	  
                            } 
                        }
                        ...
                        if(bidType == 'Platform OTB'){
                            ...
                            else if(bidlines[i].Phoenix_ProposedContractBidPriceMktng__c == null 
                                    && ( component.get("v.bidRecord.Phoenix_OTB_Marketing_Approver__c") == component.get("v.loggedInUserId") || component.get("v.loggedInUserId") == component.get("v.delegatedUserId") )
                       ...
                       /* if(bidlines[i].Phoenix_ProposedContract_Bid_Price_Sales__c == null && otbDirIndirect=='Direct'){
                            qtyError='Please Enter Sales Price Direct for '+bidlines[i].Phoenix_Product__r.Name;
                            break;
                        }
                        if(bidlines[i].Phoenix_Wholesaler_Sales_Price__c == null && otbDirIndirect=='Indirect'){
                            qtyError='Please Enter Sales Price Indirect for '+bidlines[i].Phoenix_Product__r.Name;
                            break;
                        }*/
                    }
                }
        ...
        action.setCallback(this, function(response) 
                           {
                               if(response.getState()=="SUCCESS"){
                                   ...
                                   var delegatedUserId = wrapperObj.delegatedUserId;
                                   ...
                                   var showCustoServiceProceedBtn=wrapperObj.showCustoServiceProceedBtn;
                                   console.log('showCustoServiceProceedBtn'+showCustoServiceProceedBtn);
                                   ...
                                   component.set("v.showCustoServiceProceedBtn",showCustoServiceProceedBtn);
                                   ...
                                   component.set("v.delegatedUserId",delegatedUserId);
    ...
    onRecordSubmit : function(component, event, helper){
        ...
        /*if(slctCntrcts.length==0 
           && (component.get("v.BidTypeVal")!='New Customer' 
               && component.get("v.BidTypeVal")!='Pharma Bid OTB')){
            console.log('-------test-----');
            var toastEvent = $A.get("e.force:showToast");
            toastEvent.setParams({
                "title": "Error!",
    ...
    onRecordSuccess : function(component, event, helper) {
        ...
        if (helper.requiredValidation(component, event)){
            console.log('inside validation is done');
            ...
            action.setCallback(this, function(response) {
                ...
                console.log('state from saveLineItems :: '+state);
                if (state === "SUCCESS") {
        ...
        action.setCallback(this, function(a) {
            ...
            if(ResultData != null && ResultData.length>0){
                ResultData.forEach(function(line){
                    line.Phoenix_Marketing_Notes__c = (line.Phoenix_Marketing_Notes__c!=null && line.Phoenix_Marketing_Notes__c != undefined) ? line.Phoenix_Marketing_Notes__c.replaceAll('#',' '):line.Phoenix_Marketing_Notes__c;
                    line.Phoenix_Initial_Stocking_Order_Comments__c = (line.Phoenix_Initial_Stocking_Order_Comments__c!=null && line.Phoenix_Initial_Stocking_Order_Comments__c!=undefined) ? line.Phoenix_Initial_Stocking_Order_Comments__c.replaceAll('#',' '):line.Phoenix_Initial_Stocking_Order_Comments__c;
                    line.Phoenix_SCM_Notes__c = (line.Phoenix_SCM_Notes__c!=null && line.Phoenix_SCM_Notes__c!= undefined) ? line.Phoenix_SCM_Notes__c.replaceAll('#',' '):line.Phoenix_SCM_Notes__c;
                    line.Phoenix_Sales_Notes__c = (line.Phoenix_Sales_Notes__c!=null && line.Phoenix_Sales_Notes__c!=undefined) ? line.Phoenix_Sales_Notes__c.replaceAll('#',' '):line.Phoenix_Sales_Notes__c;
                    line.Phoenix_Finance_Comments__c = (line.Phoenix_Finance_Comments__c!=null && line.Phoenix_Finance_Comments__c!=undefined) ? line.Phoenix_Finance_Comments__c.replaceAll('#',' '):line.Phoenix_Finance_Comments__c;
                    line.Phoenix_Contract_Comments__c = (line.Phoenix_Contract_Comments__c!=null && line.Phoenix_Contract_Comments__c!=undefined) ? line.Phoenix_Contract_Comments__c.replaceAll('#',' '):line.Phoenix_Contract_Comments__c;
                    line.Phoenix_Vistex_Comments__c = (line.Phoenix_Vistex_Comments__c!=null && line.Phoenix_Vistex_Comments__c!=undefined) ? line.Phoenix_Vistex_Comments__c.replaceAll('#',' '):line.Phoenix_Vistex_Comments__c;
                });
            }
