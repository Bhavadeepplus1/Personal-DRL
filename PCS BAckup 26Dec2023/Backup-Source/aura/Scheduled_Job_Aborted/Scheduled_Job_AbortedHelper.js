({
    loadDataToCalendar :function(component,data){  
       // alert('loadDataToCalendar');
        ...
        $('#calendaraborted').css('font-size', '1.2em');
        $('#calendaraborted').fullCalendar({
            customButtons: {
            },
            buttonText: {
                today:    '   Today  ',
    ...
    fetchCalenderEvents : function(component,event, element, view) {
        ...
        var action=component.get("c.getApeSyncObjAborted");
        action.setParams({ 
