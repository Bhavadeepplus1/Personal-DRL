({
    ...
    onRecordSuccess : function(component, event, helper) {
        ...
        var rebateHeader , feeHeader, marketingHeader,cdHeader;
        ...
        var cdtype = component.find("headerProCashTerms");
        if($A.util.isArray(cdtype)){
            cdtype=cdtype[0];
        }
         if(cdtype != null){
            cdHeader = cdtype.get("v.value");
        }else{
            cdHeader= '';
        }
        if(rebatetype != null){
        ...
        if (helper.requiredValidation(component, event)){
            ...
            action.setParams({
                ...
                'feeHeader': feeHeader,
                'cdHeader': cdHeader,
                'isCashTermChanged' : component.get("v.isCashTermChanged"),
 ...
 /*Product Position Logic*/
    ...
    onCashTermsChange :function(component,event, helper){
        component.set("v.showSaveCancelBtn",true);
        component.set("v.isCashTermChanged",true);
    },
