({
	...
	getFullData : function(component, event, helper) {
        ...
        console.log('selectedMemberState===>'+component.get("v.memberstatelist"));
         console.log('selectedMemberCity===>'+component.get("v.membercitylist"));
        console.log('submitname===>'+component.get("v.submitname"));
  ...
  convertArrayOfObjectsToCSV : function(component,objectRecords){
        ...
        for(var i=0; i < objectRecords.length; i++){  
            ...
            for (let [key, value] of myMap) {
                ...
                console.log('export==hosp=='+JSON.stringify(objectRecords[i].hospitalName));
                    ...
                    if(value=='hospitalName'){
                        ...
                        csvStringResult += '"'+ objectRecords[i].Hospital_Name__c +'"';
                        //objectRecords[i]["Phoenix_Product__r"]["Name"]
                    }
                    else if(value =='Child1_Name__c'){
                    
                        csvStringResult += '"'+ 'test' +'"';
                    }
    ...
    getAllTotals : function(component,event,helper) {
        ...
        var action = component.get("c.getAllTotalsMain");
        console.log('salesTerritory main==>'+component.get("v.selectedUserId"));
         console.log('userRegion main==>'+component.get("v.userRegion"));
          console.log('userCategory main==>'+component.get("v.userCategory")),
              console.log('hospitalList mian==>'+component.get("v.hospitalList")),
        console.log('child1Name main'+component.get("v.child1Name"));
        console.log('child2Name main'+component.get("v.child2Name"));
