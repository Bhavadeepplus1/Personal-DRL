            ...
            action.setCallback(this, function(response) 
                               {
                                   if(response.getState()=="SUCCESS"){
                                       ...
                                       for(var i=0;i<bidlines.length;i++){
                                           ...
                                           /*else if(component.get("v.isMarketingApprovePerson")==component.get("v.loggedInUserName") && component.get("v.loggedInUserName")== bidlines[i].Phoenix_Product_Director1__c && bidlines[i].Phoenix_ProposedContractBidPriceMktng__c==null && bidtype!='Customer Rebate Change' && bidtype!='Volume Review Only' && bidtype!='Sales Out Rebate'){
                                       ...
                                       for(var i=0;i<bidlines.length;i++){
                                            // for ovveride units
                                                       if (bidtype != 'New Product Launch' && (bidlines[i].Phoenix_Override_Current_Units__c == null && (bidlines[i].Phoenix_Current_Indirect_Selling_Unit__c == 0 || bidlines[i].Phoenix_Current_Indirect_Selling_Unit__c == undefined || bidlines[i].Phoenix_Current_Indirect_Selling_Unit__c == null))){
