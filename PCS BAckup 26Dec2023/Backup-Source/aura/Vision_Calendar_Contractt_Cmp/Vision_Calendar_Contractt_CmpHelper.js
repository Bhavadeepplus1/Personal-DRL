({
    loadDataToCalendar :function(component,data){  
       // alert('loadDataToCalendar');
        ...
        $('#calendarContract').css('font-size', '1.2em');
        $('#calendarContract').fullCalendar({
            customButtons: {
            },
            buttonText: {
                today:    '   Today  ',
        ...
        "apiName": "PanoramaTasks" // replace with the API name of your custom tab   
            ...
            eventMouseover : function(event, jsEvent, view) {
                ...
                console.log('END DATE: ' +  $A.localizationService.formatDateTime(enddate));
                    ...
                    data = '<b>Type: </b>' + event.type + '<br/>' + '<b>Name: </b>' + event.title +  '<br/>'  + '<b>Status: </b>' + event.status + '<br/>' + '<b>Contract Start Date: </b>' + enddate + '<br/> ' + '<b>Contract End Date: </b>' + startdate + '<br/>';
                }
                 else if(event.type == 'Contract Start Date'){
                    data = '<b>Type: </b>' + event.type + '<br/>' + '<b>Name: </b>' + event.title +  '<br/>'  + '<b>Status: </b>' + event.status + '<br/>' + '<b>Contract Start Date: </b>' + startdate + '<br/> ' + '<b>Contract End Date: </b>' + enddate + '<br/>';
                }
                else{
    ...
    formatFullCalendarData : function(component,events) {
       ...
       var currentDatePlusFive = new Date();
        ...
        if (events[i].type == 'Contract') {
                console.log('contract startdate====='+startdate);
                 console.log('contract enddate====='+enddate);
                 console.log('contract title====='+events[i].name);
                        josnDataArray.push({
                           title:events[i].name,
                            'start':enddate,
                            'end':enddate,
                            ...
                            'id':events[i].id,
                             icon:'/resource/1653481576000/AccountCalender_C',
               ...
               else if (events[i].type == 'Contract Start Date') {
                     //   console.log('contyract sri enddate-->'+enddate)
                        josnDataArray.push({
                            title:events[i].name,
                            'start':startdate,
                            'end':startdate,
                            'enddate':enddate,
                            'backgroundColor': "rgb(0,128,0)", // orange
                            'id':events[i].id,
                            icon: '/resource/1653400974000/AccountCalender_C',
