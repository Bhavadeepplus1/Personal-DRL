({
    ...
    doInit: function(component, event, helper){
        ...
        if(category == 'Business Lost'){
            ...
            if(record.businessCategory == 'Open Status'){
                ...
                record.priceVarianceTitle = '(Proposed Deadnet - Previous Deadnet) * Proposed Quantity';
                ...
                record.previousTPTPercentTitle = 'Previous TPT/(Previous Deadnet * Previous Quantity)';
                record.priceVarianceTitle = '(Current Deadnet - Previous Deadnet) * Awarded Quantity';
