({
    ...
    onSelectUser : function(component, event, helper){
        ...
        getBidInfoAction.setCallback(this, function (response) {
            ...
            if (actState == 'SUCCESS') {
                ...
                var dohData=doh[0].dohRecords;
                console.log('dohDataLine106>>'+JSON.stringify(dohData));
              
                component.set("v.ProductName",doh);*/
                var prodName=component.get("v.ProductName");
                console.log('prodNameLine110>>'+JSON.stringify(prodName));
                
                console.log('dohSummaryLine112-----'+JSON.stringify(component.get("v.DoHSummaryList")));
    ...
    onsearch: function (component, event, helper) {
        ...
        if(component.get("v.searchText") != undefined){
         var searchName=component.get("v.searchText");   
        }
        
        component.set('v.loaded',true);
        console.log('Hi search und-----'+searchName);
    ...
    DoH4Week : function(component, event, helper) {
        ...
        getBidInfoAction.setCallback(this, function (response) {
            ...
            if (actState == 'SUCCESS') {
                ...
                component.set("v.noOfRecords",responseWrapper.noOfRecords); 
                console.log('Line219-----'+component.get("v.ProductName"));
            }
        });
        $A.enqueueAction(getBidInfoAction); 
    },
    BOProduct : function(component, event, helper) {
        ...
        getBidInfoAction.setCallback(this, function (response) {
            ...
            if (actState == 'SUCCESS') {
                ...
                component.set("v.noOfRecords",responseWrapper.noOfRecords); 
                console.log('Line258-----'+component.get("v.ProductName"));
            }
        });
        $A.enqueueAction(getBidInfoAction); 
    },   
