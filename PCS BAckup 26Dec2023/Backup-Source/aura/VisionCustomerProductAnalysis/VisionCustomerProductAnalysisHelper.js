        ...
        action.setCallback(this, function(response){
            if(response.getState() === "SUCCESS"){
                ...
                if(scmDataList.length>0){
                    ...
                    console.log('Business Gained: '+currentTotalBG);
                    console.log('Business RG: '+currentTotalBGG);
                    console.log('Business RL: '+currentTotalBGL);
                    console.log('Business L: '+currentTotalBL);
