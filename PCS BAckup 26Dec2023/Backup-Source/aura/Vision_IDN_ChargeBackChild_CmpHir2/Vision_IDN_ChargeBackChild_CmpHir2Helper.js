        ...
        action.setParams({
         ...
         action.setCallback(this,function(response){
             ...
             if(response.getState() == 'SUCCESS'){
                 ...
                 console.log("totalsResponse hir2???"+JSON.stringify(totalsResponse));
                 console.log("sales price hir2???==>"+Math.round(totalsResponse[0].salesPrice));
                 console.log("units hir2???==>"+totalsResponse[0].units);
