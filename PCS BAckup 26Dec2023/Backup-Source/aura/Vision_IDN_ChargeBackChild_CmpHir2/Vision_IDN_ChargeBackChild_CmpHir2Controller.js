({
    doInit: function(component, event, helper){
       ...
       /* var listOfWrappers = component.get("v.listOfWrappers");
        console.log('listOfWrappers child in Hir2==>'+JSON.stringify(listOfWrappers))
        var salesTotalTwMonths =0;
          var unitsTotalTwMonths =0;
         listOfWrappers.forEach(function(eachREc){
                                         salesTotalTwMonths = eachREc.TweleveMonthsSales;
                                         unitsTotalTwMonths = eachREc.TweleveMonthsUnits;
                                     });
        component.set("v.twmonthsSalesTotal",salesTotalTwMonths)
         component.set("v.twmonthsUnitsTotal",unitsTotalTwMonths)*/
