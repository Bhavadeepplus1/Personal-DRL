       ...
       let adminBasis = component.get("v.singleRec.Phoenix_Fee_G_N__c");
        ...
        if(templateType=='Direct' || templateType=='Direct and Indirect'){
            ...
            if(adminBasis=='Gross' && rebateBasis=='Gross'){
                ...
                let requirePrice = ((deadnetPrice + (WAC*finalIndirectCD )+ (WAC*finalRDCNLC)+(perUnitReabate-(finalVIP*perUnitReabate)))/(1-(finalRebate+finalVIP+finalCMfee+finalAdminFee)));
                component.set("v.RequiredPrice",requirePrice);
                console.log('WAC--->'+WAC);
                console.log('perUnitReabate--->'+perUnitReabate);
                ...
                //satya added rebateperc because proposed rebate is not adding to the formula:final rebate is showing 0
                let requirePrice = ((deadnetPrice + (WAC*finalIndirectCD + WAC*finalRDCNLC)+(perUnitReabate-(perUnitReabate*finalAdminFee)-(perUnitReabate*finalRebate)-(finalVIP*perUnitReabate)))/(1-(finalRebate+finalVIP+finalCMfee+finalAdminFee)));
                console.log('perUnitReabate--->'+perUnitReabate);
                console.log('deadnetPrice--->'+deadnetPrice);
                console.log('finalRebate--->'+finalRebate);
                console.log('finalAdminFee--->'+finalAdminFee);
                ...
                component.set("v.RequiredPrice",requirePrice);
                 ...
                 //satya added rebateperc because proposed rebate is not adding to the formula:final rebate is showing 0
                    let requirePrice = ((deadnetPrice + (WAC*finalIndirectCD + WAC*finalRDCNLC)+(perUnitReabate-(perUnitReabate*finalRebate)-(finalVIP*perUnitReabate)))/(1-(finalRebate+finalVIP+finalCMfee+finalAdminFee)));
                    component.set("v.RequiredPrice",requirePrice);
                   console.log('gross or net')
            }
           else if(adminBasis=='Net' && rebateBasis=='Gross'){ 
              //satya added rebateperc because proposed rebate is not adding to the formula:final rebate is showing 0 
               let requirePrice = ((deadnetPrice + (WAC*finalIndirectCD + WAC*finalRDCNLC)+(perUnitReabate-(perUnitReabate*finalAdminFee)-(perUnitReabate*finalVIP)))/(1-(finalRebate+finalVIP+finalCMfee+finalAdminFee)));
                                        component.set("v.RequiredPrice",requirePrice);
                  console.log('WAC--->'+WAC);
                console.log('perUnitReabate--->'+perUnitReabate);
                console.log('finalRDCNLC--->'+finalRDCNLC);
                ...
                console.log('finalIndirectCD--->'+finalIndirectCD);
                    ...
                    //let requirePrice = (((deadnetPrice)+(finalRebate*perUnitReabate+perUnitReabate*finalAdminFee)-(perUnitReabate-(perUnitReabate*finalAdminFee)))/(1-finalRebate-finalVIP-finalCd-finalAdminFee));
                   let requirePrice = ((deadnetPrice + (WAC*finalIndirectCD + WAC*finalRDCNLC)+(perUnitReabate-(perUnitReabate*finalAdminFee)-(finalVIP*perUnitReabate)))/(1-(finalVIP+finalCMfee+finalAdminFee)));
                    
               component.set("v.RequiredPrice",requirePrice);
                } 
            else if((rebateBasis== null || rebateBasis == 'undefined' || rebateBasis == undefined) && adminBasis=='Gross'){ 
                    //let requirePrice = (((deadnetPrice)+(finalRebate*perUnitReabate+perUnitReabate*finalAdminFee)-(perUnitReabate-(perUnitReabate*finalAdminFee)))/(1-finalRebate-finalVIP-finalCd-finalAdminFee));
                   let requirePrice = ((deadnetPrice + (WAC*finalIndirectCD + WAC*finalRDCNLC)+(perUnitReabate-(finalVIP*perUnitReabate)))/(1-(finalVIP+finalCMfee+finalAdminFee)));
               ...
               component.set("v.RequiredPrice",requirePrice);
                ...
                console.log("admin fee null and rebate Net")
                    //let requirePrice = (((deadnetPrice)+(finalRebate*perUnitReabate+perUnitReabate*finalAdminFee)-(perUnitReabate-(perUnitReabate*finalAdminFee)))/(1-finalRebate-finalVIP-finalCd-finalAdminFee));
                   let requirePrice = ((deadnetPrice + (WAC*finalIndirectCD + WAC*finalRDCNLC)+(perUnitReabate-(perUnitReabate*finalRebate)-(finalVIP*perUnitReabate)))/(1-(finalRebate+finalVIP+finalCMfee)));
                    console.log("deadnetPrice--->"+deadnetPrice)
                    console.log("perUnitReabate--->"+perUnitReabate)
                    console.log("finalRebate--->"+finalRebate)
                    console.log("finalVIP--->"+finalVIP)
               ...
               component.set("v.RequiredPrice",requirePrice);
                    ...
                    //let requirePrice = (((deadnetPrice)+(finalRebate*perUnitReabate+perUnitReabate*finalAdminFee)-(perUnitReabate-(perUnitReabate*finalAdminFee)))/(1-finalRebate-finalVIP-finalCd-finalAdminFee));
                   let requirePrice = ((deadnetPrice + (WAC*finalIndirectCD + WAC*finalRDCNLC)+(perUnitReabate-(finalVIP*perUnitReabate)))/(1-(finalRebate+finalVIP+finalCMfee)));
                    
               component.set("v.RequiredPrice",requirePrice);
                }
             else if((adminBasis== null || adminBasis == 'undefined' || adminBasis == undefined) && (rebateBasis== null || rebateBasis == 'undefined' || rebateBasis == undefined)){ 
                    //let requirePrice = (((deadnetPrice)+(finalRebate*perUnitReabate+perUnitReabate*finalAdminFee)-(perUnitReabate-(perUnitReabate*finalAdminFee)))/(1-finalRebate-finalVIP-finalCd-finalAdminFee));
                   let requirePrice = ((deadnetPrice + (WAC*finalIndirectCD + WAC*finalRDCNLC)+(perUnitReabate-(finalVIP*perUnitReabate)))/(1-(finalVIP+finalCMfee)));
