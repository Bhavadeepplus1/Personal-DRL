({
    ...
    convertArrayOfObjectsToCSV : function(component,objectRecords,template,bidType,isReBid){
        ...
        if(bidType != 'New Product Launch'){
            myMap.set("3 Months Annualized CVS Direct Selling Unit","BidLineItemsExtn__r[0].Phoenix_Current_Retail_Direct_Units__c");
            myMap.set("3 Months Annualized CVS Indirect Selling Unit","BidLineItemsExtn__r[0].Phoenix_Current_Retail_Indirect_Units__c");
            myMap.set("3 Months Annualized Cardinal Selling Unit","BidLineItemsExtn__r[0].Phoenix_Current_Wholesaler_Units__c");
            ...
            myMap.set("Actual 12 Months CVS Direct Selling Unit","BidLineItemsExtn__r[0].Phoenix_12_Months_Actual_Sales__c");
            myMap.set("Actual 12 Months  CVS Indirect Selling Unit","BidLineItemsExtn__r[0].Phoenix_12_Months_IndirectSaleUnit__c");
        ...
        if(bidType != 'Price Change' && bidType != 'Sales Out Rebate' && bidType != 'Customer Rebate Change'){
            ...
            myMap.set("Proposed Total Selling Units(Current + Increment)","BidLineItemsExtn__r[0].Phoenix_Total_Selling_Unit__c");
        }
        //myMap.set("IMS Market Share", "Phoenix_IMS_Market_Share__c");
        if(bidType != "New Product Launch"){
            myMap.set("Current CVS Direct Contract Price", "BidLineItemsExtn__r[0].Phoenix_Current_Direct_Price__c");
            myMap.set("Current CVS Indirect Contract Price", "BidLineItemsExtn__r[0].Phoenix_Current_Indirect_Price__c");
            myMap.set("Current Cardinal Contract Price", "BidLineItemsExtn__r[0].Phoenix_Current_Wholesaler_Price__c");
            myMap.set("Current Major Contract Price", "BidLineItemsExtn__r[0].Phoenix_Current_Major_Contract_Price__c");
            myMap.set("Current CVS Direct Acquisition Costs", "BidLineItemsExtn__r[0].Phoenix_Current_Anda_Acquisition_Costs__c");
            myMap.set("Current Cardinal Acquisition Costs", "BidLineItemsExtn__r[0].Phoenix_Anda_Old_Acqusition_Costs__c");
