({
    ...
    doInit : function(component, event, helper) {
        ...
        else if(gcpLineItem.Phoenix_Est_Acct_Vol_Method__c == undefined || gcpLineItem.Phoenix_Est_Acct_Vol_Method__c == 'Use Calculation of Est Acct Mkt Share')
            component.set("v.estAcctVolTitle",'Est Acct Share Of Wallet * Est Acct Mkt Share * Total Market Vol (MAT - EU)');
            else if(gcpLineItem.Phoenix_Est_Acct_Vol_Method__c == 'Use Proposed Total Selling Units (BRIGHT)')
        ...
        if(component.get("v.accObj.Name") == 'Red Oak Sourcing'){
            var CvsVolString = gcpLineItem.Vision_CVS_CustAct_Volume__c.toLocaleString('en-US'),cardinalVolString = gcpLineItem.Vision_Cardinal_CustAct_Volume__c.toLocaleString('en-US'), majorVolString = gcpLineItem.Vision_Major_CustAct_Volume__c.toLocaleString('en-US');  
            component.set("v.cvsVolString", CvsVolString);component.set("v.cardinalVolString",cardinalVolString);component.set("v.majorVolString",majorVolString);
            var cvsSaleString = gcpLineItem.Vision_CVS_CustAct_Sales__c.toLocaleString('en-US'), cardinalSaleString = gcpLineItem.Vision_Cardinal_CustAct_Sales__c.toLocaleString('en-US'), majorSaleString = gcpLineItem.Vision_Major_CustAct_Sales__c.toLocaleString('en-US');
            component.set("v.cvsSaleString",cvsSaleString);component.set("v.cardinalSaleString",cardinalSaleString);component.set("v.majorSaleString",majorSaleString);
        }
    },
