({
    doInit: function(component, event, helper) {
        ...
        console.log('v.singleRec.Phoenix_Final_Finance_Approval__c-----'+record.Phoenix_Final_Finance_Approval__c);
        console.log('isVistexApprovePerson-------'+component.get("v.isVistexApprovePerson"));
