({
     callParentMethod : function(component, event, helper,indexval) {
        //Call Parent aura method

        var parentComponent = component.get("v.parent");                         
        parentComponent.childToParentMethod(component.get("v.singleRec.custId"), indexval);
         console.log('rowIndex====='+ indexval);
    },
