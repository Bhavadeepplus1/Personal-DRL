...
({
     convertArrayOfObjectsToCSV : function(component,objectRecords){
        ...
        // this labels use in CSV file header 
         ...
         myMap.set("Reporting Molecule", "Vision_GCP_Product_Family__c");
     ...
     convertArrayOfObjectsToCSVSRX : function(component,objectRecords){
        ...
        if(selectedRec2[i] == 'Authorized Generic'){
            console.log('Approved Generics');
         myMap.set("Approved Generics", "Vision_Authorized_Generic__c");   
        }
        if(selectedRec2[i] == 'Unit Dose'){
            console.log('Unit Dose');
         myMap.set("Unit Dose", "Vision_Unit_Dose__c");   
    ...
    onSortResult: function(component, event, sortField) {
      ...
      //  var action = component.get('c.fetchSortResults');
       ...
       /* var Allaccount = component.get("v.Allaccount");
        ...
        var dataValue = component.get("v.dataValue");
        console.log('dataValue-->'+ dataValue);
        var selectedProdIds = component.get("v.selectedProductsIds");
        action.setParams({
            'sortField': sortField,
        ...
        action.setCallback(this, function(response) {
            ...
            if (response.getState() === "SUCCESS") {
                ...
                component.set("v.ProductList", responseData);
                console.log('ProductList----'+JSON.stringify(responseData));
               //component.set("v.Allaccount", responseData);
                component.set("v.showSpinnerSelProds",false); 
                component.set("v.selectedProductsIds", selectedProdIds); 
                component.set("v.selectedValues", selectedValues);
                component.set("v.selectedRows", selectedRows);dataValue
                component.set("v.dataValue", dataValue);
                var qt = component.get("v.ProductList");
                component.set("v.ProductList", qt);
                 console.log('QList863-->',qt)
            }  else{
                console.log("Error "+JSON.stringify(response.getError()));
            }*/
         var currentDir = component.get("v.isAsc");
