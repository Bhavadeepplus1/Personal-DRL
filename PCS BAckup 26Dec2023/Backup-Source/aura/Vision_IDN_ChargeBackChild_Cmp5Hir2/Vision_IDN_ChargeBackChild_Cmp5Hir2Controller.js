    ...
    handleClick1: function(component, event, helper){
       var prodFamilyRelatedList = component.get("v.record.productFamilyRelatedList");
        ...
        prodFamilyRelatedList.forEach(function(rec){
           ...
           if(ndcmapObj.hasOwnProperty(rec.material_description__c)){
                
               var relatedList = ndcmapObj[rec.material_description__c];
               relatedList.push(rec);
               ndcmapObj[rec.material_description__c] = relatedList;
