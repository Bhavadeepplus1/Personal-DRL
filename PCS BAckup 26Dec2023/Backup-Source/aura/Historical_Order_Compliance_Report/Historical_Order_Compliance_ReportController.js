({
    ...
    expandAll: function(component, event, helper){
        ...
        var data = component.get("v.orderComplianceList");
        ...
        component.set("v.orderComplianceList", data); 
    ...
    downloadCsv : function(component,event,helper){    
        ...
        if(orderComplianceList != null && orderComplianceList!= undefined){
            orderComplianceList.forEach(function(item){
                familyTotalsMap[item.prodFamName] = item;
                if(item.orderComplianceList != null && item.orderComplianceList != undefined){
    ...
    openPage : function(component, event, helper){
        ...
        if(selectedPageNumber != component.get("v.selectedPageNumber")){
            var lineItems = component.get("v.orderComplianceList");
