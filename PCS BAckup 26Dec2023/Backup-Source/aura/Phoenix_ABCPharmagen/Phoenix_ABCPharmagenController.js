({
    ...
    submitFor : function(component, event, helper) { 
        ...
        console.log('selectedCntrcts-->'+selectedCntrcts);
        ...
        if(bidrecord.Phoenix_Reference_Contracts__c==null && bidtype!='New Customer'){
        ...
        else if(selectedCntrcts.length >=3){
            ...
            toastEvent.fire();  
                ...
                var  errormsg = 'You should select 3000000551 and 3000000957 contracts';
                ...
                toastEvent.fire();
                    ...
                    }else if((bidtype == 'Product Addition'||bidtype == 'New Product Launch' || bidtype == 'RFP Bids') && (bidrecord.Phoenix_Initial_Order_Discount_Type__c==null || bidrecord.Phoenix_Initial_Order_Discount_Type__c=='' || bidrecord.Phoenix_Initial_Order_Discount_Type__c=='None')){  
                    ...
                    }else if((bidtype == 'Product Addition' || bidtype == 'New Product Launch' || bidtype == 'RFP Bids') && (bidrecord.Phoenix_Proposed_Initial_Order_Discount__c == null || bidrecord.Phoenix_Proposed_Initial_Order_Discount__c== '' || bidrecord.Phoenix_Proposed_Initial_Order_Discount__c== 0) && bidrecord.Phoenix_Initial_Order_Discount_Type__c != 'Not Applicable' && bidrecord.Phoenix_Initial_Order_Discount_Type__c != 'None'){
            ...
            action.setCallback(this, function(response) 
                               {
                                   if(response.getState()=="SUCCESS"){
                                       ...
                                       for(var i=0;i<bidlines.length;i++){
                                           if((templateType=='Walgreens' ||templateType=='ABC Pharmagen' ||templateType=='ABC Progen') && bidtype!='Price Change' && bidtype!='Customer Rebate Change' && bidtype !='Sales Out Rebate' && bidlines[i].Phoenix_Proposed_Indirect_Selling_Unit__c==null){
                                            ...
                                            /*   else if (bidtype == 'New Product Launch' && bidlines[i].Phoenix_Indirect_Dead_Net__c < bidlines[i].Phoenix_Lowest_Price_SKU__c && bidlines[i].Phoenix_Internal_Dead_Net_Price__c !=0){
                                           ...
                                           /*For Delegation*/
                                                 /*  else if (bidtype == 'New Product Launch' && bidlines[i].Phoenix_Indirect_Dead_Net__c < bidlines[i].Phoenix_Lowest_Price_SKU__c && bidlines[i].Phoenix_Internal_Dead_Net_Price__c !=0 && (delegatedUser != null && delegatedUser.includes(bidlines[i].Phoenix_Product_Director1__c))){
                                                       qtyError='You cannot submit this Bid for Approval as Dead Net is less than Lowest Price/SKU: '+bidlines[i].Phoenix_Product__r.Name;
                                                       console.log('marketing Price');
                                                       break;
                                                   }*/
            ...
            toastEvent.fire();  
                ...
                toastEvent.fire();
                    ...
                    toastEvent.fire();  
                        ...
                        console.log('posi--'+component.get("v.selectedPosistions"));
    ...
    downloadCsv : function(component,event,helper){    
        ...
        action.setCallback(this, function(a) {
            ...
            var csv = helper.convertArrayOfObjectsToCSV(component,ResultData,template,bidType,isReBid,bidrecord);   
            if (csv == null){return;} 
