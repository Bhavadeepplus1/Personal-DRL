({
    getData: function(component, event, helper,showInt){
       ...
       console.log('getdata category===='+component.get("v.category"));
        var action = component.get("c.getDRLSalesRelatedList");
        
        action.setParams({
            selections: selections,
            divisonDesc: component.get("v.divisonDesc"),
        ...
        action.setCallback(this, function(response) 
                           {
                               if(response.getState()=="SUCCESS"){
                                   ...
                                   component.set("v.allResponse",response.salesList.length);
                                   ...
                                   var tempheaders = response.keySet;
                                   var tempheaderslen = response.keySet.length;
                                   var popvar1 = tempheaders[0];
                                    var popvar2 = tempheaders[tempheaderslen - 1];
                                   var header2 = popvar1.replace('-',' ')+'-'+popvar2.replace('-',' ');
                                   
                                    var tempheadersPrev = response.keySetPrev;
                                   var tempheaderslenPrev = response.keySetPrev.length;
                                   var popvar1Prev = tempheadersPrev[0];
                                    var popvar2Prev = tempheadersPrev[tempheaderslenPrev - 1];
                                   var header1 = popvar1Prev.replace('-',' ')+'-'+popvar2Prev.replace('-',' ');
                                   console.log('popvar1====='+popvar1);
                                   console.log('popvar2====='+header2);
                                   component.set("v.headerstwo",header1);
                                    component.set("v.headersone",header2);
                                   }
                                   else{
                                     var headers = response.dynamicHeaders;  
                                         component.set("v.headerstwo",headers.two);
                                    component.set("v.headersone",headers.one);
                                   }
                                   ...
                                   component.set("v.selections",selections);
                                    ...
                                    var QH2=[];
                                       ...
                                       for (var key in response.finalPrevMapSummary){
                                            QH2.push(key);
                                           console.log('srimayee sumofsales====='+response.finalPrevMapSummary[key]['prevsalesMonthlySummary']);
                                           ...
                                           if(comparison != 'lastquartervspreviousquarter'){
                                               ...
                                               sumofSales += parseFloat(response.finalPrevMapSummary[key]['prevsalesMonthlySummary']);
                                   ...
                                   console.log('srimayee sumofSales-----'+sumofSales)
                                       ...
                                       for (var key in response.finalRecentMapSummary){
                                           console.log('key test-->'+key);
                                            ...
                                            QH1.push(key);
                                           console.log('QH1 Salesdl====='+response.finalRecentMapSummary[key]['salesMonthlySummary']);
...
console.log('QuadrantHeader====='+QH1);
                                   console.log('QuadrantHeader2====='+QH2);
                                   ...
                                   var salesdlPrevSumTotal = 0;
                                    var unitsPrevSumTotal = 0;
                                    var salesdlSumTotal = 0;
                                    var unitsSumTotal = 0;
                                   for(var i=0;i<salesdlPrevSummary.length;i++){
                                       salesdlPrevSumTotal += parseInt(salesdlPrevSummary[i]);
                                   }
                                    for(var i=0;i<unitsPrevSummary.length;i++){
                                       unitsPrevSumTotal += parseInt(unitsPrevSummary[i]);
                                   }
                                    for(var i=0;i<salesdlSummary.length;i++){
                                       salesdlSumTotal += parseInt(salesdlSummary[i]);
                                   }
                                    for(var i=0;i<unitsSummary.length;i++){
                                       unitsSumTotal += parseInt(unitsSummary[i]);
                                   }
                                   component.set("v.salesdlPrevSumTotal",salesdlPrevSumTotal);
                                   component.set("v.unitsPrevSumTotal",unitsPrevSumTotal);
                                   component.set("v.salesdlSumTotal",salesdlSumTotal);
                                   component.set("v.unitsSumTotal",unitsSumTotal);
    ...
    buildData : function(component, event, helper, response) {
        ...
        component.set("v.headersList", headersList);
         var graphDiv = component.find("graphDiv");
        $A.util.addClass(graphDiv, "slds-hidden");
        var graphDivrec = component.find("graphDivrec");
        $A.util.addClass(graphDivrec, "slds-hidden");
            var summaryObj = {};
        if(response != null && response.salesList != null && response.salesList.length > 0){
              var graphDiv = component.find("graphDiv");
        $A.util.removeClass(graphDiv, "slds-hidden");
            var graphDivrec = component.find("graphDivrec");
        $A.util.removeClass(graphDivrec, "slds-hidden");
            var responseValue = response.salesList[0].childSalesList;  
        ...
        console.log('sortedResponse====='+sortedResponse.length);
            if(component.get("v.isEXTChecked")){
                ...
                console.log('Customer Ids length::: '+customerIds.length);
                 console.log('Customer allCustomerIds length::: '+allCustomerIds.length);
         ...
         /* for(var i=0;i<responseValue.length;i++){
          ...
          //  for(var i=0;i<responseValue.length;i++){
                ...
                for(var j=0; j<responseValue.length; j++){
                    ...
                    customerIds.push(responseValue[j].custId);
                    custDescList.push(responseValue[j].custName)
                    var trendingSales;
                    var trendingVolume;
                    var trendingTPT;
                    var trendingTPTPercent;
                    if(parseInt(responseValue[j].SalesDollarPrev) == 0 || parseInt(responseValue[j].salesdl) == 0){
                        trendingSales = 0;
                    } else{
                        trendingSales = (parseInt(responseValue[j].salesdl)/parseInt(responseValue[j].SalesDollarPrev))-1;
                    }
                    if(parseInt(responseValue[j].UnitsPrev) ==0 || parseInt(responseValue[j].units) == 0){
                        trendingVolume = 0;
                    } else{
                        trendingVolume = (responseValue[j].units/responseValue[j].UnitsPrev)-1;
                    }
                    if(responseValue[j].TPTDollarPrev ==0 || responseValue[j].tptdollar == 0){
                        trendingTPT = 0;
                    } else{
                        trendingTPT = (responseValue[j].tptdollar/responseValue[j].TPTDollarPrev)-1;
                    }
                    trendingTPTPercent = (responseValue[j].tptpct - responseValue[j].TPTPctPrev);
                    if(trendingTPT != null || trendingTPT != undefined) responseValue[j].trendingSales = trendingSales;
                    if(trendingVolume != null || trendingVolume != undefined) responseValue[j].trendingVolume = trendingVolume;
                    if(trendingTPT != null || trendingTPT != undefined) responseValue[j].trendingTPT = trendingTPT;
                    if(trendingTPTPercent != null || trendingTPTPercent != undefined) responseValue[j].trendingTPTPercent = trendingTPTPercent;
                    salesPrevSummary = salesPrevSummary + Math.round(responseValue[j].SalesDollarPrev);
                    console.log('salesSummary total rec-->'+Math.round(responseValue[j].salesdl));
                                        console.log('salesSummary total before-->'+salesSummary);
					salesSummary = salesSummary + Math.round(responseValue[j].salesdl);
                        console.log('salesSummary total after-->'+salesSummary);
                    salesTrendingSummary = (salesSummary/salesPrevSummary)-1;
                    volumePrevSummary = volumePrevSummary + responseValue[j].UnitsPrev;
                    console.log('volumePrevSummaryyyy-->'+volumePrevSummary);
                    volumeSummary = volumeSummary + responseValue[j].units;
                    volumeTrendingSummary = (volumeSummary/volumePrevSummary)-1;
                    tptPrevSummary = tptPrevSummary + responseValue[j].TPTDollarPrev;
                    tptSummary = tptSummary + responseValue[j].tptdollar;
          ...
          //  }
            //for cust id's//
            for(var i=0;i<custDescList.length;i++){
                allCustomerIds.push(customerIds[i]);
                if(!allcustDescList.includes(custDescList[i])){
        ...
        */
            ...
            if(component.get("v.showBoolean")){
                console.log('abcccc--'+component.get("v.allResponse"));
                
           //    if(component.get("v.resList").length > 0){
                ...
                console.log('component.find----'+JSON.stringify(component.find('andeeChart5')));
                console.log('component.find----'+component.find('andeeChart5').getElement());
                ...
                console.log('chartobj5 before destroy====='+chartobj5);
                if(chartobj5){
                  ...
                  /*  chartobj5.destroy();
                    ...
                    chartobj5 = new Chart(ctx6, {
                        ...
                        data: {
                            ...
                            datasets: [
                                {
                                    label: component.get("v.headerstwo"),
                                    borderColor: 'rgba(237, 125, 49)',
                                    backgroundColor:'rgba(237, 125, 49)',
                                    fill: false,
                                ...
                                {
                                    label: component.get("v.headersone"),
                    ...
                    console.log('chartobj6 before set====='+chartobj6);
                                        console.log('chartobj5 before set====='+chartobj5);

                      component.set("v.chartobj5",chartobj5);
                component.set("v.chartobj6",chartobj6);
                    console.log('chartobj6 after set=='+component.get("v.chartobj6"));
                                   console.log('chartobj5 after set=='+component.get("v.chartobj5"));
                  /*  chartobj5.destroy();
                    chartobj6.destroy();*/
                }
      ...
      /*  var QSumUnits = parseInt(component.get("v.sumOfPrevUnits"))+parseInt(component.get("v.sumOfRecentUnits"));
         var QSumSales = parseInt(component.get("v.sumOfPrevSales"))+parseInt(component.get("v.sumOfRecentSales"));
        component.set("v.QSumUnits",QSumUnits);
         component.set("v.QSumSales",QSumSales);*/
    ...
    getChartData: function(component, event, helper,showInt,recentLastMonth,previousLastMonth){
        ...
        console.log('custDesc List: '+component.get("v.custDescList"));
         console.log('allcustDescList: '+component.get("v.allcustDescList"));
        //var action = component.get("c.getDRLSalesRelatedList");
        ...
        action.setCallback(this, function(response) 
                           {
                               if(response.getState()=="SUCCESS"){
                                   ...
                                   console.log('Graph size====='+response.length);
                                   component.set("v.loaded", false);
                               } else{
                                   component.set("v.loaded", false);
                                   console.log("Error "+JSON.stringify(response.getError()));
