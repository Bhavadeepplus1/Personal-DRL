({
    ...
    saveChangetoAccPlan : function(component, event, helper){
     ...
     handleChange : function(component, event, helper) {
        console.log('Selected Contract Id: '+component.get("v.selectedAccount"));
       var accountId=component.get("v.selectedAccount");
        ...
        action.setCallback(this, function(response){
            if(response.getState()=="SUCCESS"){
                ...
                console.log('accValuesOverview='+JSON.stringify(accPlanValues));
                
                console.log('response.length ---> '+response.length);
                
                component.set("v.length",accountId);
