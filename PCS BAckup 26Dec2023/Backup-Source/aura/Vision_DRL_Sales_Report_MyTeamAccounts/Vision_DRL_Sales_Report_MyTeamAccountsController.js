({
    initRecords : function(component,event,helper){
      ...
      /*  if(component.get("v.responseList").length !=0){
            component.set("v.showBoolean",true);
        }else{
             component.set("v.showBoolean",false);
        }*/
        console.log('do init-->'+component.get("v.responseList").length)
        helper.getData(component, event, helper,selectedUserId,showInt);
        // console.log('do init1-->'+component.get("v.responseList").length)
    ...
    searchIntExt: function(component, event, helper){
        ...
        var selectedUserId = component.get("v.selectedUser");
        var showInt= component.get("v.ShowINT");
        console.log('showInt in controller'+showInt)
      helper.getData(component, event, helper,selectedUserId,showInt);  
    },
    ...
    getMoreChartsData: function(component, event, helper){
        ...
        console.log('show int in getmorecharts data-->'+showInt)
    ...
    onChangeUser: function(component, event, helper){
        ...
        var showInt= component.get("V.ShowINT");
         helper.getData(component, event, helper,selectedUserName,showInt);
    ...
    onSelectUser : function(component, event, helper){
        ...
        // component.set("v.salesdlSummary", []);
        var showInt= component.get("V.ShowINT");
        component.set("v.res",[])
        console.log('rest-->'+component.get("v.res"))
        if(component.get("v.res") != null){
                                        component.set("v.showBoolean",true);
                                    }else{
                                         component.set("v.showBoolean",false);
                                    }
        helper.getData(component, event, helper,selectedId,showInt);
