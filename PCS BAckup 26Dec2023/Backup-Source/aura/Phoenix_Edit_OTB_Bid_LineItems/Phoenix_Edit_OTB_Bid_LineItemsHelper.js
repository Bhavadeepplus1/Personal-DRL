({
    ...
    convertArrayOfObjectsToCSV : function(component,objectRecords,template,bidType,isReBid,otbDirIndirect){
        ...
        console.log('convert bidType====='+BidTypeVal);
        ...
        myMap.set("Proposed Direct Units (Current + Increment)", "Phoenix_Proposed_Direct_Selling_Unit__c");
    ...
    submitForProceed : function(component,event,helper,isContracts){ 
        ...
        action.setCallback(this, function(response)
                           ...
                           {
                               console.log('rtesponse OTB'+JSON.stringify(response.getReturnValue())); 
                               if (response.getState() === "SUCCESS") {
                                   component.set('v.isSpinnerLoad',false);
                                   ...
                                   for(var i=0;i<resultlength;i++){
                                       console.log('resultslength-^^^^^^^^^^^^^6-'+resultlength);
                                       /*  if(bidtype!='Price Change' && bidtype!='Customer Rebate Change' && bidtype !='Sales Out Rebate' && (ResultData[i].Phoenix_Direct_ESI__c==null  && ResultData[i].Phoenix_Direct_Kroger__c==null  && ResultData[i].Phoenix_Direct_Rx_Outreach__c==null  && ResultData[i].Phoenix_Direct_Supervalu__c==null && ResultData[i].Phoenix_Direct_Cigna__c==null && ResultData[i].Phoenix_Direct_Cordant__c==null && ResultData[i].Phoenix_Direct_Accerodo__c==null &&  ResultData[i].Phoenix_Others_Direct__c==null )){
                                           qtyError='Please Enter Others Direct Selling Units for '+ResultData[i].Phoenix_Product__r.Name;
                                           console.log('in direct');
                                           break;
                                       }
                                       if(bidtype!='Price Change' && bidtype!='Customer Rebate Change' && bidtype !='Sales Out Rebate' && (ResultData[i].Phoenix_Indirect_ESI__c==null  && ResultData[i].Phoenix_Indirect_Kroger__c==null  && ResultData[i].Phoenix_Indirect_Rx_Outreach__c==null  && ResultData[i].Phoenix_Indirect_Supervalu__c==null && ResultData[i].Phoenix_Indirect_Cigna__c==null && ResultData[i].Phoenix_Indirect_Cordant__c==null && ResultData[i].Phoenix_Indirect_Accerodo__c==null &&  ResultData[i].Phoenix_Others_Indirect__c==null )){
                                           qtyError='Please Enter Others Indirect Selling Units for '+ResultData[i].Phoenix_Product__r.Name;
                                           console.log('in Indirect');
                                           break;
                                       }*/
                                       if(component.get("v.BidAprrovalStatus")!='Draft' && (ResultData[i].Phoenix_Product_Director__c==component.get("v.loggedInUserName") || (delegatedUser != null && delegatedUser.includes(ResultData[i].Phoenix_Product_Director__c))) && otbDirIndirect=='Indirect' && ResultData[i].Phoenix_Wholesaler_Diff_Price_Indirect__c==null  ){	
                                       ...
                                       else if(component.get("v.BidAprrovalStatus")!='Draft' && (ResultData[i].Phoenix_Product_Director__c==component.get("v.loggedInUserName") || (delegatedUser != null && delegatedUser.includes(ResultData[i].Phoenix_Product_Director__c))) && ResultData[i].Phoenix_ProposedContractBidPriceMktng__c==null && otbDirIndirect=='Direct'  ){	
                                           if(ResultData[i].Phoenix_Marketing_Approval__c !='Not Approved'){
                                   ...
                                   if(qtyError){	
                                       ...
                                       if(resultlength==0){
                                           ...
                                           if(isContracts==false && component.get("v.BidAprrovalStatus")!='Customer Service'){
                                           ...
                                           else  if(isContracts==false && component.get("v.BidAprrovalStatus")=='Customer Service'){
                                               ...
                                               ResultData.forEach(function(line){
                                                   ...
                                                   /*else{
                                                       component.set("v.conAppStepButtonDisable",false);
                                                       console.log("button"+component.get("v.conAppStepButtonDisable"));
                                                       
                                                   }*/
                                                   if(line['Phoenix_Customer_Service_Status__c']=='Processed'){
                                                       
                                                       
                                                       console.log('---------------customer service started-----2-------');
                                                       approveStatusFlag=true;  
                                                   } 
