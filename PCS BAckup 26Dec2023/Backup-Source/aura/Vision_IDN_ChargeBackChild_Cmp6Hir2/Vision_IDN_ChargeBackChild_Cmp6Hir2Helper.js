        ...
        console.log('salesTerritory==>'+component.get("v.selectedUserId"));
         console.log('userRegion==>'+component.get("v.userRegion"));
          console.log('userCategory==>'+component.get("v.userCategory")),
              console.log('hospitalName cmp6==>'+component.get("v.hospitalName")),
        console.log('child1Name cmp6'+component.get("v.child1Name"));
        console.log('child2Name cmp6'+component.get("v.child2Name"));
        console.log('productFamily cmp6'+component.get("v.selectedProductFamilies"));
         console.log('productDescription cmp6'+component.get("v.record.material_Description__c"));
        ...
        action.setParams({
         ...
         action.setCallback(this,function(response){
             ...
             if(response.getState() == 'SUCCESS'){
                 ...
                 console.log("totalsResponse hir2 cmp6???"+JSON.stringify(totalsResponse));
                 console.log("sales price hir2 cmp6???==>"+Math.round(totalsResponse[0].salesPrice));
                 console.log("units hir2 cmp6???==>"+totalsResponse[0].units);
